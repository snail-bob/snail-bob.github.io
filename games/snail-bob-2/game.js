...
function ImagesPreloader() {
  function a() {
    var e = 0,
      f = 0,
      g;
    for (g in c.loadedImages) c.loadedImages[g].complete && e++, f++;
    e >= f
      ? c.endCallback && c.endCallback(c.loadedImages)
      : (c.processCallback &&
          c.processCallback(
            Math.floor((e / f) * c.maxProgressVal + c.minProgressVal)
          ),
        setTimeout(a, 50));
  }
  var c = this;
...
function SoundsPreloader(a, c, e) {
  ...
  this.load = function () {
    if (!this.sounds || 1 > this.sounds.length)
      ...
      for (
        var a = this.isMp3Support() ? "mp3" : "ogg",
          c,
          e,
          l = (this.loadedCount = 0);
            ...
            ? ((c = window.XMLHttpRequest
              ...
              (c.onreadystatechange = function () {
                if (4 == this.readyState && 200 == this.status)
                  ...
                  } else f.soundIsLoaded();
              }),
              (c.soundSrc = e),
              c.send())
            : ((c = document.createElement("audio")),
              (c.src = e),
              (c.type = "mp3" == a ? "audio/mpeg" : "audio/ogg"),
              (c.preload = "auto"),
              c.load(),
              c.addEventListener("canplay", f.soundIsLoaded));
  };
  this.soundIsLoaded = function () {
    ...
    f.progressCallback &&
      f.progressCallback(
        Math.floor(
          (f.loadedCount / f.sounds.length) * f.maxProgressVal +
            f.minProgressVal
        )
      );
...
var Utils = {
    ...
    parseGet: function () {
      ...
      if (-1 != e)
        for (
          var c = c.substr(e + 1, c.length), e = c.split("&"), f = 0;
          f < e.length;
          f++
        )
          (c = e[f].split("=")), (a[c[0]] = c[1]);
      return a;
    },
    globalPixelScale: 1,
    ...
    checkSpilgamesEnvironment: function () {
      return (
        "undefined" != typeof ExternalAPI &&
        "Spilgames" == ExternalAPI.type &&
        ExternalAPI.check()
      );
    },
    ...
    getMobileScreenResolution: function (a) {
      var c = 1,
        ...
        g = "";
      Utils.touchScreen
        ? ((f.width = Math.min(window.innerWidth, window.innerHeight)),
          (f.height = Math.max(window.innerWidth, window.innerHeight)))
    ...
    imagesRoot: "images",
    initialResolution: { width: 320, height: 480, scale: 1 },
    createLayout: function (a, c, e, f) {
      ...
      g =
        "" +
        ('<div id="progress_container" align="center" style="width: 100%; height: ' +
          e +
          'px; display: block; width: 100%; position: absolute; left: 0px; top: 0px;">') +
        ('<table cellspacing="0" cellpadding="0"><tr><td id="progress" align="center" valign="middle" style="width: ' +
          c.width +
          "px; height: " +
          c.height +
          "px; color: #000; background: #fff; font-weight: bold; font-family: Verdana; font-size: " +
          12 * g +
          'px; vertical-align: middle;"></td></tr></table>');
      g += "</div>";
      g +=
        '<div id="screen_background_container" style="width: 100%; height: ' +
        e +
        'px; position: absolute; left: 0px; top: 0px; display: none; z-index: 2;">';
      g +=
        '<div id="screen_background_wrapper" style="width: ' +
        c.width +
        "px; height: " +
        c.height +
        'px; position: relative; left: 0px;">';
      f ||
        (g +=
          '<canvas id="screen_background" width="' +
          c.width +
          '" height="' +
          c.height +
          '"></canvas>');
      ...
      g += "</div>";
      g +=
        '<div id="screen_container" style="width: 100%; height: ' +
        e +
        'px; position: absolute; left: 0px; top: 0px; display: none; z-index: 3;">';
      g +=
        '<div id="screen_wrapper" width="' +
        c.width +
        '" height="' +
        c.height +
        '" style="width: ' +
      ...
      f ||
        (g +=
          '<canvas id="screen" style="position: absolute; left: 0px; top: 0px; z-index: 1000000;" width="' +
          c.width +
          '" height="' +
          c.height +
      ...
      a.setAttribute(
        ...
        "width: 100%; height: " +
          e +
          "px; position: absolute; left: 0px; top: 0px; visibility: hidden; z-index: 1000; background: #fff;"
      );
      c = (c - 240) / 2;
    ...
    addMobileListeners: function (a, c) {
      (!c && navigator.userAgent.match(/(iPad|iPhone|iPod).*CPU.*OS 7_\d/i)) ||
        Utils.bindEvent(document.body, "touchstart", Utils.preventEvent);
      Utils.isPlayFreeBrowser() ||
        Utils.bindEvent(window, "scroll", function (a) {
          setTimeout(Utils.mobileHideAddressBar, 300);
        });
      setInterval(
        "Utils.checkOrientation(" + (a ? "true" : "false") + ")",
        500
      );
    ...
    getWindowRect: function () {
      ...
      return Utils.isAndroid() && a
        ? { width: window.innerWidth, height: a.offsetTop + 1 }
    ...
    checkOrientation: function (a) {
      if (Utils.touchScreen && document.getElementById("screen_container")) {
        ...
        Utils.noCheckOrient ||
          1 == c.nocheckorient ||
          ((c = Utils.getWindowRect()),
          (c = c.width > c.height),
          Utils.storeOrient !== c &&
            ((Utils.storeOrient = c),
            c != a
              ? (Utils.dispatchEvent("lockscreen"),
                (document.getElementById("p2l_container").style.visibility =
                  "visible"),
                (document.getElementById(
                  "screen_background_container"
                ).style.display = "none"),
                (document.getElementById("screen_container").style.display =
                  "none"))
              : (Utils.dispatchEvent("unlockscreen"),
                ...
                (document.getElementById("screen_container").style.display =
                  "block")),
            Utils.checkSpilgamesEnvironment() &&
    ...
    fitLayoutToScreen: function (a) {
      if (!Utils.fitLayoutLock) {
        var c, e, f, g;
        ("object" == typeof a && a.width) ||
          ((g = Utils.getWindowRect()),
          (e = g.width),
          (f = g.height),
          Utils.checkSpilgamesEnvironment() && (f -= 25),
          (f += Utils.fitLayoutCorrectHeight),
          (a = { width: e, height: f }));
        if ((c = document.getElementById("screen_wrapper"))) {
          c.initWidth ||
            ((c.initWidth = Utils.initialResolution.width),
    ...
    drawIphoneLimiter: function (a, c) {
      c
        ? a.drawRectangle(240, 295, 480, 54, "#f00", !0, 0.5, !0)
        : a.drawRectangle(160, 448, 320, 64, "#f00", !0, 0.5, !0);
    },
    drawGrid: function (a, c, e) {
      ...
      for (h = 10; h < c; h += 10)
        (k = 0.1 + (((h - 10) / 10) % 10) * 0.1),
          a.drawLine(0, h, g, h, f, e, k);
    },
    drawScaleFix: function (a, c) {
      0.75 == Utils.globalScale &&
        (c
          ? a.drawRectangle(507, 160, 54, 320, "#000", !0, 1, !0)
          : a.drawRectangle(160, 507, 320, 54, "#000", !0, 1, !0));
      1.5 == Utils.globalScale &&
        (c
          ? a.drawRectangle(510, 160, 60, 320, "#000", !0, 1, !0)
          : a.drawRectangle(160, 510, 320, 60, "#000", !0, 1, !0));
    },
  ...
  EventsManager = {
    addEvent: function (a, c, e) {
      if (a.eventsListeners) {
        for (var f = 0; f < a.eventsListeners.length; f++)
          if (
            a.eventsListeners[f].type === c &&
            a.eventsListeners[f].callback === e
          )
            return;
      ...
      if (a.eventsListeners)
        for (var f = 0; f < a.eventsListeners.length; f++)
          if (
            ...
            a.eventsListeners = Utils.removeFromArray(
              a.eventsListeners,
              a.eventsListeners[f]
            );
            break;
    ...
    dispatchEvent: function (a, c, e) {
      if (a.eventsListeners) {
        var f;
        if (
          "function" == typeof a["on" + c] &&
          ((f = a["on" + c](e)), !1 === f)
        )
          return !1;
        for (var g = 0; g < a.eventsListeners.length; g++)
          if (
            a.eventsListeners[g].type === c &&
            ((f = a.eventsListeners[g].callback(e)), !1 === f)
          )
            return !1;
      }
    },
...
function Sprite(a, c, e, f, g) {
  ...
  this.addTween = function (a, c, e, f, g, p) {
    if (this.stage) {
      ...
      if (!isNaN(q))
        return (
          (a = stage.createTween(this, a, q, c, e, f)),
          (a.onchange = p),
          (a.onfinish = g),
          a
        );
  ...
  this.moveTo = function (a, c, e, f, g, p) {
    ...
    0 >= e
      ...
      : ((a = this.addTween("x", a, e, f, g, p)) && a.play(),
        (c = this.addTween("y", c, e, f, a ? null : g, a ? null : p)) &&
          c.play());
    return this;
  };
  ...
  this.fadeTo = function (a, c, e, f, g) {
    ...
    0 >= c
      ? (this.opacity = a)
      : (a = this.addTween("opacity", a, c, e, f, g)) && a.play();
    return this;
  };
  ...
  this.rotateTo = function (a, c, e, f, g) {
    ...
    0 >= c
      ? (this.rotation = a)
      : (a = this.addTween("rotation", a, c, e, f, g)) && a.play();
    return this;
  };
  ...
  this.scaleTo = function (a, c, e, f, g) {
    ...
    if (0 >= c) this.scaleX = this.scaleY = a;
      ...
      p && p.play();
      (a = this.addTween("scaleY", a, c, e, p ? null : f, p ? null : g)) &&
        a.play();
    }
    return this;
  };
  this.nextFrame = function () {
    ...
    this.animated &&
      ...
      this.currentFrame >= this.totalFrames && (this.currentFrame = 0));
  };
...
var Easing = {
  back: {
    ...
    easeInOut: function (a, c, e, f) {
      var g = 1.70158;
      return 1 > (a /= f / 2)
        ? (e / 2) * a * a * (((g *= 1.525) + 1) * a - g) + c
        : (e / 2) * ((a -= 2) * a * (((g *= 1.525) + 1) * a + g) + 2) + c;
    },
  },
  bounce: {
    easeIn: function (a, c, e, f) {
    ...
    easeOut: function (a, c, e, f) {
      return (a /= f) < 1 / 2.75
        ? 7.5625 * e * a * a + c
        : a < 2 / 2.75
        ? e * (7.5625 * (a -= 1.5 / 2.75) * a + 0.75) + c
        : a < 2.5 / 2.75
        ? e * (7.5625 * (a -= 2.25 / 2.75) * a + 0.9375) + c
        : e * (7.5625 * (a -= 2.625 / 2.75) * a + 0.984375) + c;
    },
    easeInOut: function (a, c, e, f) {
      return a < f / 2
        ? 0.5 * Easing.bounce.easeIn(2 * a, 0, e, f) + c
        : 0.5 * Easing.bounce.easeOut(2 * a - f, 0, e, f) + 0.5 * e + c;
    },
  },
  circular: {
    easeIn: function (a, c, e, f) {
    ...
    easeInOut: function (a, c, e, f) {
      return 1 > (a /= f / 2)
        ? (-e / 2) * (Math.sqrt(1 - a * a) - 1) + c
        : (e / 2) * (Math.sqrt(1 - (a -= 2) * a) + 1) + c;
    },
  },
  cubic: {
    easeIn: function (a, c, e, f) {
  ...
  exponential: {
    ...
    easeInOut: function (a, c, e, f) {
      return 0 == a
        ...
        ? c + e
        : 1 > (a /= f / 2)
        ? (e / 2) * Math.pow(2, 10 * (a - 1)) + c
        : (e / 2) * (-Math.pow(2, -10 * --a) + 2) + c;
    },
  },
  linear: {
    easeIn: function (a, c, e, f) {
    ...
    if (!this.paused) {
      ...
      if (0 >= this.timeout)
        if (
          ...
          "string" == typeof this.callback && eval(this.callback),
          this.repeat)
        )
...
function Stage(a, c, e) {
  ...
  function g() {
    ...
    h.showFPS &&
      (h.setTextStyle("sans-serif", 10, "bold", "#fff", "#000"),
      h.drawText("FPS: " + h.lastFPS, 2, 10, 1, !0));
  ...
  this.ceilSizes =
    ...
    this.pixelMouseDownEvent =
    this.pixelMouseUpEvent =
    this.pixelClickEvent =
    this.showFPS =
      !1;
  this.tmMain;
  this.tmFPS;
  ...
  this.clearScreen = function (a) {
    this.clearLock ||
      a.ctx.clearRect(
        0,
        0,
        this.screenWidth * Utils.globalScale * Utils.globalPixelScale,
        this.screenHeight * Utils.globalScale * Utils.globalPixelScale
      );
  };
  ...
  this.findMinZIndex = function () {
    for (var a = -1, c = !1, e = 0; e < this.objects.length; e++)
      0 == e && ((a = this.objects[e].zIndex), (c = 0)),
        this.objects[e].zIndex < a && ((a = this.objects[e].zIndex), (c = e));
    return { index: c, zIndex: a };
  };
  ...
  this.removeChild = function (a) {
    a &&
      (this.clearObjectTweens(a),
      a.dispatchEvent("remove", { target: a }),
      (a.stage = null),
      (this.objects = Utils.removeFromArray(this.objects, a)));
  };
  ...
  this.hitTestPointObject = function (a, c, e, f, g, h) {
    ...
    v = c;
    y = e;
    a.ignoreViewport || ((v += this.viewport.x), (y += this.viewport.y));
    h = !1;
    0 == a.rotation
      ? k <= v && t <= y && k + u >= v && t + x >= y && (h = !0)
      : ((k = a.getDrawRectangle()),
        k.hitTestPoint(new Vector(v, y)) && (h = !0));
    h &&
      f &&
      ((this.buffer.width =
        this.screenWidth * Utils.globalScale * Utils.globalPixelScale),
      ...
      this.renderObject(this.buffer, a),
      (c = this.buffer.ctx.getImageData(
        Math.floor(c * Utils.globalScale * Utils.globalPixelScale),
        Math.floor(e * Utils.globalScale * Utils.globalPixelScale),
        1,
        1
      )),
      0 == c.data[3] && (h = !1));
  ...
  this.getObjectsStackByCoord = function (a, c, e, f, g) {
    for (var h, k = [], t = 0; t < this.objects.length; t++)
      if (this.objects[t].visible || this.objects[t].eventsWhenInvisible)
        (h = this.objects[t]),
          this.hitTestPointObject(h, a, c, e, f, g) && k.push(h);
    return k;
  };
  ...
  this.sortStack = function (a, c) {
    for (var e = !0, f, g; e; )
      for (e = !1, g = 0; g < a.length - 1; g++)
        (f = !1),
          a[g].zIndex < a[g + 1].zIndex && !c && (f = !0),
          a[g].zIndex > a[g + 1].zIndex && c && (f = !0),
          f && ((e = a[g]), (a[g] = a[g + 1]), (a[g + 1] = e), (e = !0));
    return a;
  };
  ...
  this.checkClick = function (a) {
    ...
    var c = this.getObjectsStackByCoord(
        this.prepareMouseCoord(a.x),
        this.prepareMouseCoord(a.y),
        this.pixelClickEvent,
        !1,
        !0
      ),
    ...
    if (0 < c.length)
      for (
        var c = this.sortStack(c), f = 0;
        f < c.length &&
        ((e = this.finalizeMouseCoords(c[f], a)),
        (e = c[f].dispatchEvent("click", { target: c[f], x: e.x, y: e.y })),
        !1 !== e);
        f++
      );
  };
  this.checkContextMenu = function (a) {
    ...
    if (0 < c.length)
      for (
        ...
        f < c.length &&
        ((e = this.finalizeMouseCoords(c[f], a)),
        (e = c[f].dispatchEvent("contextmenu", {
          target: c[f],
          x: e.x,
          y: e.y,
        })),
  ...
  this.checkMouseMove = function (a) {
    ...
    for (f = 0; f < this.objects.length; f++)
      if (this.objects[f].dragged) {
        ...
        this.objects[f].ignoreViewport ||
          ((c += this.viewport.x), (e += this.viewport.y));
    ...
    if (0 < c.length) {
      ...
      for (
        ...
        f < c.length &&
        (e.push(c[f]),
        (h = this.finalizeMouseCoords(c[f], a)),
        c[f].mouseOn ||
      ...
      for (
        ...
        f < c.length &&
        ((h = this.finalizeMouseCoords(c[f], a)),
        (g = c[f].dispatchEvent("mousemove", { target: c[f], x: h.x, y: h.y })),
        !1 !== g);
        f++
      );
    }
    for (f = 0; f < this.objects.length; f++)
      if (this.objects[f].mouseOn) {
        h = !1;
        for (g = 0; g < e.length; g++) e[g] == this.objects[f] && (h = !0);
        if (
          !h &&
          ((this.objects[f].mouseOn = !1),
          (h = this.finalizeMouseCoords(c[f], a)),
          (g = this.objects[f].dispatchEvent("mouseout", {
  ...
  this.checkMouseDown = function (a) {
    ...
    if (0 < c.length)
      for (
        ...
        f < c.length &&
        ((e = this.finalizeMouseCoords(c[f], a)),
        (e = c[f].dispatchEvent("mousedown", { target: c[f], x: e.x, y: e.y })),
        !1 !== e);
        f++
      );
  };
  this.checkMouseUp = function (a) {
    ...
    if (0 < c.length)
      for (
        ...
        f < c.length &&
        ((e = this.finalizeMouseCoords(c[f], a)),
        (e = c[f].dispatchEvent("mouseup", { target: c[f], x: e.x, y: e.y })),
        !1 !== e);
        f++
      );
  };
  ...
  this.drawRectangle = function (a, c, e, f, g, h, k, t) {
    var u = this.canvas;
    ...
    h
      ? u.ctx.fillRect(a - e / 2, c - f / 2, e, f)
      : u.ctx.strokeRect(a - e / 2, c - f / 2, e, f);
  };
  ...
  this.drawLine = function (a, c, e, f, g, h, k, t) {
    ...
    u.ctx.lineWidth = g
      ? g * Utils.globalScale * Utils.globalPixelScale
      : 1 * Utils.globalScale * Utils.globalPixelScale;
  ...
  this.setTextStyle = function (a, c, e, f, g, h) {
    h = h ? h : this.canvas;
    h.ctx.fillStyle = f;
    h.ctx.strokeStyle = g;
    f = "";
    e && (f += e + " ");
    c &&
      (f += Math.floor(c * Utils.globalScale * Utils.globalPixelScale) + "px ");
    a && (f += a);
    h.ctx.font = f;
  };
  ...
  this.strokeText = function (a, c, e, f, g, h, k) {
    k = k ? k : this.canvas;
    k.ctx.globalAlpha = "undefined" == typeof f ? 1 : f;
    g || ((c -= this.viewport.x), (e -= this.viewport.y));
    c = c * Utils.globalScale * Utils.globalPixelScale;
  ...
  this.renderObject = function (a, c) {
    if (!1 !== c.dispatchEvent("prerender", { target: c, canvas: a })) {
      ...
      ox =
        e.x * Utils.globalPixelScale * Utils.globalScale - Math.floor(ow / 2);
      oy =
        e.y * Utils.globalPixelScale * Utils.globalScale - Math.floor(oh / 2);
      or = c.rotation;
      ...
      canvasMod &&
        (a.ctx.save(),
        a.ctx.translate(ox + Math.floor(ow / 2), oy + Math.floor(oh / 2)),
        a.ctx.rotate(or),
        a.ctx.scale(scX, scY),
        (ox = -Math.floor(ow / 2)),
        (oy = -Math.floor(oh / 2)));
      ...
      c.fillColor &&
        ((a.ctx.fillStyle = c.fillColor),
        (a.ctx.strokeStyle = c.fillColor),
        a.ctx.fillRect(ox, oy, ow, oh));
      if (c.bitmap) {
        var e = c.bitmap.width,
          f = c.bitmap.height,
          g = c.currentLayer * ow + c.offset.left * Utils.globalScale,
          h = c.currentFrame * oh + c.offset.top * Utils.globalScale;
        if (g < e && h < f) {
          var k = ow,
            t = oh,
            u = !1;
          ...
          c.mask &&
            ...
            this.buffer.ctx.clearRect(0, 0, k, t),
            this.buffer.ctx.drawImage(c.bitmap, g, h, k, t, 0, 0, k, t),
            (this.buffer.ctx.globalCompositeOperation = "destination-in"),
            this.buffer.ctx.drawImage(c.mask, 0, 0),
            (h = g = 0),
            (u = !0));
          try {
            a.ctx.drawImage(
              u ? this.buffer : c.bitmap,
              ~~g,
              ~~h,
              ~~k,
              ~~t,
      ...
      this.allowDebugDrawing &&
        c.allowDebugDrawing &&
        ((!this.allowStaticDebugDrawing && c.static) || c.debugDraw());
      c.dispatchEvent("render", { target: c, canvas: a });
    }
  };
  ...
  this.drawBackBuffer = function (a, c) {
    !c &&
      this.backBuffer &&
      this.drawBackAlways &&
      a.ctx.drawImage(this.backBuffer, 0, 0, a.width, a.height);
  };
  this.drawScene = function (a, c) {
    var e, f;
    a && !a.ctx && (a.ctx = a.getContext("2d"));
    this.fillColor
      ? ((a.ctx.fillStyle = this.fillColor),
        a.ctx.fillRect(
          0,
          0,
          this.screenWidth * Utils.globalScale * Utils.globalPixelScale,
        ...
        this.drawBackBuffer(a, c))
      : this.clearLock || (this.clearScreen(a), this.drawBackBuffer(a, c));
    for (var g = 0; g < this.objects.length; g++)
      (e = this.objects[g]),
        ...
        f &&
          (e.destroy
            ? (this.removeChild(e), g--)
            : (e.nextFrame(), e.visible && this.renderObject(a, e)));
    c && (this.backBuffer = a);
  };
  this.tweens = [];
  ...
  this.processTouchEvent = function (a, c) {
    for (var e = 0; e < a.length; e++)
      h[c]({ clientX: a[e].clientX, clientY: a[e].clientY });
  };
...
var Rectangle = function (a, c, e, f, g) {
    ...
    this.refreshVertices = function () {
      ...
      for (a = 0; 4 > a; a++)
        this.vertices[a].rotate(-this.angle, this.center),
          this.vertices[a].x < this.AABB[0].x &&
            (this.AABB[0].x = this.vertices[a].x),
          this.vertices[a].x > this.AABB[1].x &&
            (this.AABB[1].x = this.vertices[a].x),
          this.vertices[a].y < this.AABB[0].y &&
            (this.AABB[0].y = this.vertices[a].y),
          this.vertices[a].y > this.AABB[1].y &&
            (this.AABB[1].y = this.vertices[a].y);
    };
    ...
    this.hitTestPoint = function (a) {
      ...
      return (
        Math.abs(a.x) <= this.width / 2 && Math.abs(a.y) <= this.height / 2
      );
    };
    this.hitTestRectangle = function (a) {
      ...
      a.rotate(-this.angle);
      e =
        Math.max(c.AABB[0].x, c.AABB[1].x, a.AABB[0].x, a.AABB[1].x) -
        Math.min(c.AABB[0].x, c.AABB[1].x, a.AABB[0].x, a.AABB[1].x);
      f = c.AABB[1].x - c.AABB[0].x;
      g = a.AABB[1].x - a.AABB[0].x;
      if (e > f + g) return !1;
      e =
        Math.max(c.AABB[0].y, c.AABB[1].y, a.AABB[0].y, a.AABB[1].y) -
  ...
  AssetsLibrary = function (a, c, e) {
    ...
    this.init = function (a, c) {
      ...
      "undefined" != typeof c &&
        ((this.scale = parseFloat(c)), isNaN(this.scale) && (this.scale = 1));
    };
    ...
    this.getAsset = function (a, c) {
      var e = null;
      "undefined" != typeof this.items[a] &&
        this.items[a].bitmap &&
        (e =
          ("undefined" != typeof c && !c) || this.items[a].ready
            ? this.items[a]
            : null);
...
(function (GLOBAL) {
  ...
  function writeAttribute(element, name, value) {
    ...
    for (var attr in attributes) {
      ...
      if (table.values[attr]) name = table.values[attr](element, value) || name;
...
b2Mat22.prototype = {
  initialize: function (a, c, e) {
    ...
    null != c && null != e
      ? (this.col1.SetV(c), this.col2.SetV(e))
      : ((c = Math.cos(a)),
        (a = Math.sin(a)),
        (this.col1.x = c),
        (this.col2.x = -a),
...
b2Math.b2MulMV = function (a, c) {
  return new b2Vec2(
    a.col1.x * c.x + a.col2.x * c.y,
    a.col1.y * c.x + a.col2.y * c.y
  );
};
...
b2Math.AddMM = function (a, c) {
  return new b2Mat22(
    0,
    b2Math.AddVV(a.col1, c.col1),
    b2Math.AddVV(a.col2, c.col2)
  );
};
...
b2Math.b2MulTMM = function (a, c) {
  var e = new b2Vec2(
      b2Math.b2Dot(a.col1, c.col1),
      b2Math.b2Dot(a.col2, c.col1)
    ),
...
b2AABB.prototype = {
  IsValid: function () {
    ...
    return (a =
      0 <= a && 0 <= c && this.minVertex.IsValid() && this.maxVertex.IsValid());
  },
...
b2PairManager.prototype = {
  ...
  AddBufferedPair: function (a, c) {
    ...
    !1 == e.IsBuffered() &&
      (e.SetBuffered(),
      (this.m_pairBuffer[this.m_pairBufferCount].proxyId1 = e.proxyId1),
      (this.m_pairBuffer[this.m_pairBufferCount].proxyId2 = e.proxyId2),
  ...
  Commit: function () {
    for (
      var a = 0, c = 0, e = this.m_broadPhase.m_proxyPool, a = 0;
      a < this.m_pairBufferCount;
      ++a
    ) {
      var f = this.Find(
        this.m_pairBuffer[a].proxyId1,
      ...
      f.IsRemoved()
        ? (!0 == f.IsFinal() &&
            this.m_callback.PairRemoved(g.userData, h.userData, f.userData),
          (this.m_pairBuffer[c].proxyId1 = f.proxyId1),
          (this.m_pairBuffer[c].proxyId2 = f.proxyId2),
          ++c)
        : !1 == f.IsFinal() &&
          ((f.userData = this.m_callback.PairAdded(g.userData, h.userData)),
          f.SetFinal());
    }
    for (a = 0; a < c; ++a)
      this.RemovePair(
  ...
  RemovePair: function (a, c) {
    ...
    for (
      var f = b2PairManager.Hash(a, c) & b2Pair.b2_tableMask,
        g = this.m_hashTable[f],
        h = null;
      g != b2Pair.b2_nullPair;

    ) {
      if (b2PairManager.Equals(this.m_pairs[g], a, c))
        return (
          (e = g),
          h
            ? (h.next = this.m_pairs[g].next)
            : (this.m_hashTable[f] = this.m_pairs[g].next),
          (f = this.m_pairs[e]),
          (g = f.userData),
...
b2BroadPhase.prototype = {
  ...
  GetProxy: function (a) {
    return a == b2Pair.b2_nullProxy || !1 == this.m_proxyPool[a].IsValid()
      ? null
      : this.m_proxyPool[a];
  },
  CreateProxy: function (a, c) {
    ...
    for (var l = 0; 2 > l; ++l) {
      ...
      for (
        var n = n[0], p = p[0], e = [], q = 0, r = f - p, s, t, q = 0;
        q < r;
        q++
      )
        (e[q] = new b2Bound()),
      ...
      for (e = n; e < f + 2; ++e)
        (n = this.m_proxyPool[m[e].proxyId]),
  ...
  DestroyProxy: function (a) {
    for (
      var c = this.m_proxyPool[a], e = 2 * this.m_proxyCount, f = 0;
      2 > f;
      ++f
    ) {
      for (
        var g = this.m_bounds[f],
          h = c.lowerBounds[f],
          k = c.upperBounds[f],
          l = g[h].value,
          m = g[k].value,
      ...
      q = e - 2;
      for (n = h; n < q; ++n)
        (p = this.m_proxyPool[g[n].proxyId]),
  ...
  MoveProxy: function (a, c) {
    var e = 0,
      ...
      l;
    if (
      !(a == b2Pair.b2_nullProxy || b2Settings.b2_maxProxies <= a) &&
      !1 != c.IsValid()
    ) {
      ...
      for (var q = new b2BoundValues(), e = 0; 2 > e; ++e)
        (q.lowerValues[e] = this.m_bounds[e][n.lowerBounds[e]].value),
          (q.upperValues[e] = this.m_bounds[e][n.upperBounds[e]].value);
      for (e = 0; 2 > e; ++e) {
        ...
        if (0 > v)
          for (f = s; 0 < f && u < r[f - 1].value; )
            (g = r[f]),
              ...
              h.stabbingCount++,
              !0 == h.IsUpper()
                ? (this.TestOverlap(p, l) &&
                    this.m_pairManager.AddBufferedPair(a, k),
                  l.upperBounds[e]++,
                  g.stabbingCount++)
            ...
            (g = r[f]),
              ...
              !0 == h.IsLower()
                ? (this.TestOverlap(p, l) &&
                  ...
                  l.lowerBounds[e]--,
                  g.stabbingCount++)
                : (l.upperBounds[e]--, g.stabbingCount--),
              n.upperBounds[e]++,
              g.Swap(h),
              f++;
        if (0 < v)
          for (f = s; f < m - 1 && r[f + 1].value <= u; )
            (g = r[f]),
              ...
              h.stabbingCount--,
              h.IsUpper()
                ? (this.TestOverlap(q, l) &&
                    this.m_pairManager.RemoveBufferedPair(a, k),
                  l.upperBounds[e]--,
                  g.stabbingCount--)
                : (l.lowerBounds[e]--, g.stabbingCount++),
              n.lowerBounds[e]++,
  ...
  Validate: function () {
    for (var a = 0; 2 > a; ++a)
      for (
        var c = this.m_bounds[a], e = 2 * this.m_proxyCount, f = 0, g = 0;
        g < e;
        ++g
      )
        !0 == c[g].IsLower() ? f++ : f--;
  ...
  ComputeBounds: function (a, c, e) {
    ...
    a[0] =
      (this.m_quantizationFactor.x * (f - this.m_worldAABB.minVertex.x)) &
      (b2Settings.USHRT_MAX - 1);
    c[0] =
      ((this.m_quantizationFactor.x * (h - this.m_worldAABB.minVertex.x)) &
        65535) |
      1;
    a[1] =
      (this.m_quantizationFactor.y * (g - this.m_worldAABB.minVertex.y)) &
      (b2Settings.USHRT_MAX - 1);
    c[1] =
  ...
  TestOverlapValidate: function (a, c) {
    for (var e = 0; 2 > e; ++e) {
      ...
      if (
        f[a.lowerBounds[e]].value > f[c.upperBounds[e]].value ||
        f[a.upperBounds[e]].value < f[c.lowerBounds[e]].value
      )
        return !1;
    }
    return !0;
  ...
  TestOverlap: function (a, c) {
    for (var e = 0; 2 > e; ++e) {
      var f = this.m_bounds[e];
      if (
        a.lowerValues[e] > f[c.upperBounds[e]].value ||
        a.upperValues[e] < f[c.lowerBounds[e]].value
      )
        return !1;
    }
    return !0;
  ...
  Query: function (a, c, e, f, g, h, k) {
    ...
    if (0 < e) {
      ...
      for (var l = g[h].stabbingCount; l; )
        g[h].IsLower() &&
          e <= this.m_proxyPool[g[h].proxyId].upperBounds[k] &&
          (this.IncrementOverlapCount(g[h].proxyId), --l),
          --h;
    }
    a[0] = e;
    c[0] = f;
  ...
  IncrementOverlapCount: function (a) {
    ...
    c.timeStamp < this.m_timeStamp
      ? ((c.timeStamp = this.m_timeStamp), (c.overlapCount = 1))
      : ((c.overlapCount = 2),
...
b2Collision.EdgeSeparation = function (a, c, e) {
  for (
    var f = a.m_vertices,
      ...
      m = k,
      n = a.m_R,
      k = n.col1.x * m + n.col2.x * l,
      l = n.col1.y * m + n.col2.y * l,
      p = k,
      q = l,
      n = e.m_R,
      m = p * n.col1.x + q * n.col1.y,
      q = p * n.col2.x + q * n.col2.y,
      p = m,
      m = 0,
      n = Number.MAX_VALUE,
      r = 0;
...
b2Collision.b2CollidePoly = function (a, c, e, f) {
  ...
  if (!(0 < k && !1 == f)) {
    ...
    if (!(0 < m && !1 == f)) {
      ...
      s = b2Collision.ClipSegmentToLine(
        q,
        e,
...
b2Collision.b2CollideCircle = function (a, c, e, f) {
  ...
  (k > c * c && !1 == f) ||
    ...
    g.id.set_key(0),
    (g.separation = f),
    (g.position.x = e.m_position.x - e.m_radius * a.normal.x),
    (g.position.y = e.m_position.y - e.m_radius * a.normal.y));
};
b2Collision.b2CollidePolyAndCircle = function (a, c, e, f) {
  ...
  for (g = 0; g < c.m_vertexCount; ++g) {
    var p =
      c.m_normals[g].x * (h - c.m_vertices[g].x) +
      c.m_normals[g].y * (k - c.m_vertices[g].y);
    if (p > l) return;
    p > n && ((n = p), (m = g));
  }
    ...
    if (r < Number.MIN_VALUE)
      (h -= c.m_vertices[m].x),
        ...
        k > l ||
          ((a.pointCount = 1),
          a.normal.Set(
            f.col1.x * h + f.col2.x * c,
            f.col1.y * h + f.col2.y * c
          ),
          (g = a.points[0]),
          (g.id.features.incidentEdge = b2Collision.b2_nullFeature),
          (g.id.features.incidentVertex = m),
          (g.id.features.referenceFace = b2Collision.b2_nullFeature),
          (g.id.features.flip = 0),
          (g.position.x = e.m_position.x - l * a.normal.x),
          (g.position.y = e.m_position.y - l * a.normal.y),
      ...
      0 >= s
        ...
        ? ((q = c.m_vertices[n].x),
          (c = c.m_vertices[n].y),
          (g.id.features.incidentVertex = n))
        : ((q = q * s + c.m_vertices[m].x),
          (c = p * s + c.m_vertices[m].y),
          (g.id.features.incidentEdge = m));
      h -= q;
      c = k - c;
      k = Math.sqrt(h * h + c * c);
      ...
      k > l ||
        ((a.pointCount = 1),
        a.normal.Set(f.col1.x * h + f.col2.x * c, f.col1.y * h + f.col2.y * c),
        (g.position.x = e.m_position.x - l * a.normal.x),
        (g.position.y = e.m_position.y - l * a.normal.y),
        (g.separation = k - l));
    }
...
b2Distance.ProcessThree = function (a, c, e, f, g) {
  ...
  if (0 >= l && 0 <= D && 0 <= u)
    return (
      (v = D / (D + u)),
      (a.x = e[1].x + v * (e[2].x - e[1].x)),
      (a.y = e[1].y + v * (e[2].y - e[1].y)),
      (c.x = f[1].x + v * (f[2].x - f[1].x)),
      (c.y = f[1].y + v * (f[2].y - f[1].y)),
      e[0].SetV(e[2]),
      f[0].SetV(f[2]),
      g[0].SetV(g[2]),
      2
  ...
  if (0 >= h && 0 <= v && 0 <= y)
    return (
      (v /= v + y),
      (a.x = e[0].x + v * (e[2].x - e[0].x)),
      (a.y = e[0].y + v * (e[2].y - e[0].y)),
      (c.x = f[0].x + v * (f[2].x - f[0].x)),
      (c.y = f[0].y + v * (f[2].y - f[0].y)),
      e[1].SetV(e[2]),
      f[1].SetV(f[2]),
      g[1].SetV(g[2]),
      2
...
b2Shape.Destroy = function (a) {
  a.m_proxyId != b2Pair.b2_nullProxy &&
...
b2Shape.PolyMass = function (a, c, e, f) {
  ...
  for (var h = 0, k = 0, l = new b2Vec2(0, 0), m = 1 / 3, n = 0; n < e; ++n) {
    ...
    k +=
      u *
      (m * (0.25 * (r * r + x * r + x * x) + (q * r + q * x)) +
        0.5 * q * q +
        (m * (0.25 * (s * s + t * s + t * t) + (p * s + p * t)) + 0.5 * p * p));
  }
  a.mass = f * h;
  g.Multiply(1 / h);
  a.center = g;
...
Object.extend(b2CircleShape.prototype, {
  ...
  initialize: function (a, c, e) {
    ...
    c.InRange(a)
      ? (this.m_proxyId = c.CreateProxy(a, this))
      : (this.m_proxyId = b2Pair.b2_nullProxy);
  ...
  Synchronize: function (a, c, e, f) {
    this.m_R.SetM(f);
    this.m_position.x =
      f.col1.x * this.m_localPosition.x +
      f.col2.x * this.m_localPosition.y +
      e.x;
    this.m_position.y =
      f.col1.y * this.m_localPosition.x +
      f.col2.y * this.m_localPosition.y +
      e.y;
    if (this.m_proxyId != b2Pair.b2_nullProxy) {
      e =
        a.x +
        (c.col1.x * this.m_localPosition.x + c.col2.x * this.m_localPosition.y);
      f =
        a.y +
        (c.col1.y * this.m_localPosition.x + c.col2.y * this.m_localPosition.y);
  ...
  QuickSync: function (a, c) {
    this.m_R.SetM(c);
    this.m_position.x =
      c.col1.x * this.m_localPosition.x +
      c.col2.x * this.m_localPosition.y +
      a.x;
    this.m_position.y =
      c.col1.y * this.m_localPosition.x +
      c.col2.y * this.m_localPosition.y +
      a.y;
  },
  ResetProxy: function (a) {
    if (this.m_proxyId != b2Pair.b2_nullProxy) {
  ...
  Support: function (a, c, e) {
    ...
    e.Set(
      this.m_position.x + (a / f) * this.m_radius,
      this.m_position.y + (c / f) * this.m_radius
    );
  },
...
Object.extend(b2PolyShape.prototype, {
  ...
  initialize: function (a, c, e) {
    ...
    if (a.type == b2Shape.e_boxShape) {
      ...
      this.m_localCentroid.x =
        a.localPosition.x + (h.col1.x * k + h.col2.x * l) - e.x;
      this.m_localCentroid.y =
        a.localPosition.y + (h.col1.y * k + h.col2.y * l) - e.y;
      for (f = 0; f < this.m_vertexCount; ++f) {
        ...
        this.m_coreVertices[f].x =
          this.m_vertices[f].x - 2 * b2Settings.b2_linearSlop * e;
        this.m_coreVertices[f].y =
          this.m_vertices[f].y - 2 * b2Settings.b2_linearSlop * g;
      }
    }
    ...
    f.InRange(c)
      ? (this.m_proxyId = f.CreateProxy(c, this))
      : (this.m_proxyId = b2Pair.b2_nullProxy);
    this.m_proxyId == b2Pair.b2_nullProxy && this.m_body.Freeze();
  },
  syncAABB: new b2AABB(),
  ...
  Synchronize: function (a, c, e, f) {
    ...
    this.m_position.x =
      this.m_body.m_position.x +
      (f.col1.x * this.m_localCentroid.x + f.col2.x * this.m_localCentroid.y);
    this.m_position.y =
      this.m_body.m_position.y +
      (f.col1.y * this.m_localCentroid.x + f.col2.y * this.m_localCentroid.y);
    if (this.m_proxyId != b2Pair.b2_nullProxy) {
      var g, h;
      g = c.col1;
      h = c.col2;
      ...
      e.InRange(this.syncAABB)
        ? e.MoveProxy(this.m_proxyId, this.syncAABB)
        : this.m_body.Freeze();
    }
  },
  QuickSync: function (a, c) {
    ...
    this.m_position.x =
      a.x +
      (c.col1.x * this.m_localCentroid.x + c.col2.x * this.m_localCentroid.y);
    this.m_position.y =
      a.y +
      (c.col1.y * this.m_localCentroid.x + c.col2.y * this.m_localCentroid.y);
  },
  ResetProxy: function (a) {
    if (this.m_proxyId != b2Pair.b2_nullProxy) {
      a.GetProxy(this.m_proxyId);
      ...
      f.maxVertex.Add(c);
      a.InRange(f)
        ? (this.m_proxyId = a.CreateProxy(f, this))
        : (this.m_proxyId = b2Pair.b2_nullProxy);
      this.m_proxyId == b2Pair.b2_nullProxy && this.m_body.Freeze();
    }
  },
  Support: function (a, c, e) {
    ...
    c = 0;
    for (
      var g = this.m_coreVertices[0].x * f + this.m_coreVertices[0].y * a,
        h = 1;
    ...
    e.Set(
      this.m_position.x +
        (this.m_R.col1.x * this.m_coreVertices[c].x +
          this.m_R.col2.x * this.m_coreVertices[c].y),
      this.m_position.y +
        (this.m_R.col1.y * this.m_coreVertices[c].x +
          this.m_R.col2.y * this.m_coreVertices[c].y)
    );
  },
...
b2Body.prototype = {
  ...
  GetPosition: function () {
    ...
    a = this.m_position.x;
    c = this.m_position.y;
    if (0 != this.m_center.x || 0 != this.m_center.y)
      (a -=
        this.m_center.x * Math.cos(-this.m_rotation) +
        this.m_center.y * Math.sin(-this.m_rotation)),
        (c -=
          this.m_center.x * -Math.sin(-this.m_rotation) +
  ...
  ApplyForce: function (a, c) {
    !1 == this.IsSleeping() &&
      ...
      (this.m_torque += b2Math.b2CrossVV(
        b2Math.SubtractVV(c, this.m_position),
        a
      )));
  },
  ...
  ApplyImpulse: function (a, c) {
    !1 == this.IsSleeping() &&
      ...
      (this.m_angularVelocity +=
        this.m_invI *
        b2Math.b2CrossVV(b2Math.SubtractVV(c, this.m_position), a)));
  },
  GetMass: function () {
    return this.m_mass;
  },
  ...
  initialize: function (a, c) {
    ...
    for (
      var h = Array(b2Settings.b2_maxShapesPerBody), e = 0;
      e < b2Settings.b2_maxShapesPerBody;
      e++
    )
      h[e] = new b2MassData();
    this.m_shapeCount = 0;
    ...
    for (e = this.m_I = 0; e < this.m_shapeCount; ++e)
      (f = a.shapes[e]),
        ...
        (this.m_I += g.I),
        (f = b2Math.SubtractVV(
          b2Math.AddVV(f.localPosition, g.center),
          this.m_center
        )),
        (this.m_I += g.mass * b2Math.b2Dot(f, f));
    this.m_invMass = 0 < this.m_mass ? 1 / this.m_mass : 0;
    this.m_invI =
      0 < this.m_I && !1 == a.preventRotation ? 1 / this.m_I : (this.m_I = 0);
  ...
  IsConnected: function (a) {
    for (var c = this.m_jointList; null != c; c = c.next)
      if (c.other == a) return !1 == c.joint.m_collideConnected;
    return !1;
  },
  Freeze: function () {
...
b2CollisionFilter.prototype = {
  ShouldCollide: function (a, c) {
    return a.m_groupIndex == c.m_groupIndex && 0 != a.m_groupIndex
      ? 0 < a.m_groupIndex
      : 0 != (a.m_maskBits & c.m_categoryBits) &&
          0 != (a.m_categoryBits & c.m_maskBits);
  },
  initialize: function () {},
};
...
b2Island.prototype = {
  ...
  Solve: function (a, c) {
    for (var e = 0, f, e = 0; e < this.m_bodyCount; ++e)
      (f = this.m_bodies[e]),
        0 != f.m_invMass &&
          (f.m_linearVelocity.Add(
            b2Math.MulFV(
              a.dt,
              b2Math.AddVV(c, b2Math.MulFV(f.m_invMass, f.m_force))
            )
          ),
          (f.m_angularVelocity += a.dt * f.m_invI * f.m_torque),
          f.m_linearVelocity.Multiply(f.m_linearDamping),
          (f.m_angularVelocity *= f.m_angularDamping),
          f.m_position0.SetV(f.m_position),
          (f.m_rotation0 = f.m_rotation));
    var g = new b2ContactSolver(
      this.m_contacts,
      this.m_contactCount,
      this.m_allocator
    );
    ...
    for (e = 0; e < this.m_bodyCount; ++e)
      (f = this.m_bodies[e]),
        0 != f.m_invMass &&
          ((f.m_position.x += a.dt * f.m_linearVelocity.x),
          (f.m_position.y += a.dt * f.m_linearVelocity.y),
          (f.m_rotation += a.dt * f.m_angularVelocity),
    ...
    if (b2World.s_enablePositionCorrection)
      for (
        ...
        b2Island.m_positionIterationCount < a.iterations;
  ...
  UpdateSleep: function (a) {
    for (
      ...
      (e = this.m_bodies[c]),
        0 != e.m_invMass &&
          (0 == (e.m_flags & b2Body.e_allowSleepFlag) &&
            (f = e.m_sleepTime = 0),
          0 == (e.m_flags & b2Body.e_allowSleepFlag) ||
          e.m_angularVelocity * e.m_angularVelocity > h ||
          b2Math.b2Dot(e.m_linearVelocity, e.m_linearVelocity) > g
            ? (f = e.m_sleepTime = 0)
            : ((e.m_sleepTime += a), (f = b2Math.b2Min(f, e.m_sleepTime))));
...
b2Contact.AddType = function (a, c, e, f) {
  ...
  e != f &&
    ((b2Contact.s_registers[f][e].createFcn = a),
    (b2Contact.s_registers[f][e].destroyFcn = c),
    (b2Contact.s_registers[f][e].primary = !1));
};
...
b2Contact.Destroy = function (a, c) {
  0 < a.GetManifoldCount() &&
    (a.m_shape1.m_body.WakeUp(), a.m_shape2.m_body.WakeUp());
  var e =
    b2Contact.s_registers[a.m_shape1.m_type][a.m_shape2.m_type].destroyFcn;
  e(a, c);
};
...
b2ContactSolver.prototype = {
    ...
    for (e = 0; e < c; ++e)
      for (
        var k = a[e],
          l = k.m_shape1.m_body,
          m = k.m_shape2.m_body,
          n = k.GetManifoldCount(),
          p = k.GetManifolds(),
          q = k.m_friction,
          k = k.m_restitution,
          r = l.m_linearVelocity.x,
          s = l.m_linearVelocity.y,
          t = m.m_linearVelocity.x,
          u = m.m_linearVelocity.y,
          x = l.m_angularVelocity,
        ...
        for (var G = 0; G < C.pointCount; ++G) {
          ...
          E =
            C.normal.x * (t + -v * A - r - -x * H) +
            C.normal.y * (u + v * J - s - x * E);
          E < -b2Settings.b2_velocityThreshold &&
            (z.velocityBias += -C.restitution * E);
        }
        ++h;
      }
  },
      ...
      if (b2World.s_enableWarmStarting)
        for (u = f.pointCount, t = 0; t < u; ++t) {
          var x = f.points[t],
            ...
            y = x.normalImpulse * q + x.tangentImpulse * s;
          c = g.m_R;
          a = x.localAnchor1;
  ...
  SolveVelocityConstraints: function () {
    for (
      var a = 0, c, e, f, g, h, k, l, m, n = 0;
      n < this.m_constraintCount;
      ++n
    ) {
      for (
        var p = this.m_constraints[n],
          q = p.body1,
          r = p.body2,
          s = q.m_angularVelocity,
          t = q.m_linearVelocity,
        ...
        (c = p.points[a]),
          ...
          (k = x.x + -u * h - t.x - -s * f),
          (l = x.y + u * g - t.y - s * e),
          (k = -c.normalMass * (k * F + l * C - c.velocityBias)),
  ...
  SolvePositionConstraints: function (a) {
    for (var c = 0, e, f, g = 0; g < this.m_constraintCount; ++g) {
      for (
        var h = this.m_constraints[g],
          k = h.body1,
          l = h.body2,
          m = k.m_position,
          n = k.m_rotation,
        ...
        f =
          (p.x + G - (m.x + F)) * x + (p.y + e - (m.y + C)) * v + B.separation;
        c = b2Math.b2Min(c, f);
        f =
          a *
          b2Math.b2Clamp(
  ...
  PostSolve: function () {
    for (var a = 0; a < this.m_constraintCount; ++a)
      for (
        var c = this.m_constraints[a], e = c.manifold, f = 0;
        f < c.pointCount;
        ++f
      ) {
        var g = e.points[f],
...
b2Conservative.Conservative = function (a, c) {
  ...
  if (H)
    return (
      ...
      e.IsStatic()
        ? ((e.m_position.x = y), (e.m_position.y = D))
        : ((e.m_position.x = y - z), (e.m_position.y = D - E)),
      (e.m_rotation = B),
      e.m_R.Set(B),
      e.QuickSyncShapes(),
      f.IsStatic()
        ? ((f.m_position.x = F), (f.m_position.y = C))
        : ((f.m_position.x = F + z), (f.m_position.y = C + E)),
      (f.m_position.x = F + z),
      (f.m_position.y = C + E),
      (f.m_rotation = G),
      f.m_R.Set(G),
...
Object.extend(b2PolyContact.prototype, {
  ...
  Evaluate: function () {
    for (
      var a = this.m_manifold[0], c = this.m0.points, e = 0;
      e < a.pointCount;
      e++
    ) {
      var f = c[e],
...
Object.extend(b2ContactManager.prototype, {
  ...
  PairAdded: function (a, c) {
    var e = a,
      ...
      h = f.m_body;
    if (
      (g.IsStatic() && h.IsStatic()) ||
      e.m_body == f.m_body ||
      h.IsConnected(g) ||
      (null != this.m_world.m_filter &&
        !1 == this.m_world.m_filter.ShouldCollide(e, f))
    )
  ...
  PairRemoved: function (a, c, e) {
    null != e &&
      e != this.m_nullContact &&
      (!0 == this.m_destroyImmediate
        ? this.DestroyContact(e)
        : (e.m_flags |= b2Contact.e_destroyFlag));
  },
  ...
  Collide: function () {
    for (
      var a, c, e, f, g = this.m_world.m_contactList;
      null != g;
      g = g.m_next
    )
      (g.m_shape1.m_body.IsSleeping() && g.m_shape2.m_body.IsSleeping()) ||
        ((a = g.GetManifoldCount()),
        g.Evaluate(),
        (c = g.GetManifoldCount()),
        0 == a && 0 < c
          ? ((a = g.m_shape1.m_body),
            (c = g.m_shape2.m_body),
            (e = g.m_node1),
            ...
            (e.other = c),
            (e.prev = null),
            (e.next = a.m_contactList),
            null != e.next && (e.next.prev = g.m_node1),
            (a.m_contactList = g.m_node1),
            (f.contact = g),
            (f.other = a),
            (f.prev = null),
            (f.next = c.m_contactList),
          ...
          : 0 < a &&
            ...
            e == a.m_contactList && (a.m_contactList = e.next),
            (e.prev = null),
            (e.next = null),
            f.prev && (f.prev.next = f.next),
            f.next && (f.next.prev = f.prev),
...
b2World.prototype = {
  ...
  CreateJoint: function (a) {
    ...
    if (!1 == a.collideConnected)
      for (
        a = (a.body1.m_shapeCount < a.body2.m_shapeCount ? a.body1 : a.body2)
          .m_shapeList;
        a;
        a = a.m_next
      )
  ...
  DestroyJoint: function (a) {
    ...
    if (!1 == c)
      for (
        a = (e.m_shapeCount < f.m_shapeCount ? e : f).m_shapeList;
        a;
        a = a.m_next
      )
        a.ResetProxy(this.m_broadPhase);
      ...
      if (
        ...
        for (k.m_flags |= b2Body.e_islandFlag; 0 < l; )
          if (
            ...
            g.AddBody(e),
            (e.m_flags &= ~b2Body.e_sleepFlag),
            !(e.m_flags & b2Body.e_staticFlag))
          ) {
            for (var m = e.m_contactList; null != m; m = m.next)
              m.contact.m_flags & b2Contact.e_islandFlag ||
                (g.AddContact(m.contact),
                (m.contact.m_flags |= b2Contact.e_islandFlag),
                (f = m.other),
                f.m_flags & b2Body.e_islandFlag ||
                  ((h[l++] = f), (f.m_flags |= b2Body.e_islandFlag)));
        ...
        for (f = 0; f < g.m_bodyCount; ++f)
          (e = g.m_bodies[f]),
            ...
            e.IsFrozen() &&
              this.m_listener &&
              this.m_listener.NotifyBoundaryViolated(e) ==
                b2WorldListener.b2_destroyBody &&
  ...
  PrepareVelocitySolver: function () {
    ...
    b2World.s_enableWarmStarting
      ? ((g = this.m_impulse * this.m_u.x),
        ...
        (this.m_body1.m_linearVelocity.y -= this.m_body1.m_invMass * h),
        (this.m_body1.m_angularVelocity -=
          this.m_body1.m_invI * (c * h - e * g)),
        (this.m_body2.m_linearVelocity.x += this.m_body2.m_invMass * g),
        (this.m_body2.m_linearVelocity.y += this.m_body2.m_invMass * h),
        (this.m_body2.m_angularVelocity +=
          this.m_body2.m_invI * (f * h - a * g)))
      : (this.m_impulse = 0);
  },
  SolveVelocityConstraints: function (a) {
    var c;
    ...
    var g =
      -this.m_mass *
      (this.m_u.x *
        (this.m_body2.m_linearVelocity.x +
          -this.m_body2.m_angularVelocity * c -
          (this.m_body1.m_linearVelocity.x +
            -this.m_body1.m_angularVelocity * e)) +
        this.m_u.y *
          (this.m_body2.m_linearVelocity.y +
            this.m_body2.m_angularVelocity * f -
            (this.m_body1.m_linearVelocity.y +
              this.m_body1.m_angularVelocity * a)));
    this.m_impulse += g;
    var h = g * this.m_u.x,
      g = g * this.m_u.y;
...
b2Jacobian.prototype = {
  ...
  Compute: function (a, c, e, f) {
    return (
      ...
      this.linear1.y * a.y +
      this.angular1 * c +
      (this.linear2.x * e.x + this.linear2.y * e.y) +
      this.angular2 * f
    );
  },
  initialize: function () {
...
Object.extend(b2GearJoint.prototype, {
  ...
  initialize: function (a) {
    ...
    a.joint1.m_type == b2Joint.e_revoluteJoint
    ...
    a.joint2.m_type == b2Joint.e_revoluteJoint
  ...
  PrepareVelocitySolver: function () {
    ...
    this.m_J.SetZero();
    this.m_revolute1
      ? ((this.m_J.angular1 = -1), (l += e.m_invI))
      : ((k = a.m_R),
        (g = this.m_prismatic1.m_localXAxis1),
        (a = k.col1.x * g.x + k.col2.x * g.y),
        (g = k.col1.y * g.x + k.col2.y * g.y),
        (k = e.m_R),
        (h =
          k.col1.x * this.m_localAnchor1.x + k.col2.x * this.m_localAnchor1.y),
        (k =
          k.col1.y * this.m_localAnchor1.x + k.col2.y * this.m_localAnchor1.y),
        (h = h * g - k * a),
        this.m_J.linear1.Set(-a, -g),
        (this.m_J.angular1 = -h),
        (l += e.m_invMass + e.m_invI * h * h));
    this.m_revolute2
      ? ((this.m_J.angular2 = -this.m_ratio),
        (l += this.m_ratio * this.m_ratio * f.m_invI))
      : ((k = c.m_R),
        ...
        (k = f.m_R),
        (h =
          k.col1.x * this.m_localAnchor2.x + k.col2.x * this.m_localAnchor2.y),
        (k =
          k.col1.y * this.m_localAnchor2.x + k.col2.y * this.m_localAnchor2.y),
        (h = h * g - k * a),
        this.m_J.linear2.Set(-this.m_ratio * a, -this.m_ratio * g),
...
Object.extend(b2MouseJoint.prototype, {
  ...
  initialize: function (a) {
    ...
    this.m_localAnchor.x =
      c * this.m_body2.m_R.col1.x + e * this.m_body2.m_R.col1.y;
    this.m_localAnchor.y =
      c * this.m_body2.m_R.col2.x + e * this.m_body2.m_R.col2.y;
  ...
  SolveVelocityConstraints: function (a) {
    ...
    var h =
        h +
        this.m_beta * a.inv_dt * this.m_C.x +
        this.m_gamma * this.m_impulse.x,
      l =
        k +
        this.m_beta * a.inv_dt * this.m_C.y +
    ...
    k > a.dt * this.m_maxForce &&
      this.m_impulse.Multiply((a.dt * this.m_maxForce) / k);
...
Object.extend(b2PrismaticJoint.prototype, {
  ...
  GetJointTranslation: function () {
    ...
    e = a.m_R;
    return (
      (e.col1.x * this.m_localXAxis1.x + e.col2.x * this.m_localXAxis1.y) * f +
      (e.col1.y * this.m_localXAxis1.x + e.col2.y * this.m_localXAxis1.y) * c
    );
  },
  GetJointSpeed: function () {
    ...
    return (
      l * -a * e +
      m * a * n +
      (n * (q.x + -c * k - p.x - -a * g) + e * (q.y + c * h - p.y - a * f))
    );
  },
  ...
  GetReactionForce: function (a) {
    ...
    c = this.m_body1.m_R;
    return new b2Vec2(
      a * (c.col1.x * this.m_localXAxis1.x + c.col2.x * this.m_localXAxis1.y) +
        a * (c.col1.x * this.m_localYAxis1.x + c.col2.x * this.m_localYAxis1.y),
      a * (c.col1.y * this.m_localXAxis1.x + c.col2.y * this.m_localXAxis1.y) +
        a * (c.col1.y * this.m_localYAxis1.x + c.col2.y * this.m_localYAxis1.y)
    );
  },
  GetReactionTorque: function (a) {
  ...
  initialize: function (a) {
    ...
    this.m_localAnchor1.Set(
      e * c.col1.x + f * c.col1.y,
      e * c.col2.x + f * c.col2.y
    );
    c = this.m_body2.m_R;
  ...
  PrepareVelocitySolver: function () {
    ...
    this.m_linearMass =
      l +
      n * this.m_linearJacobian.angular1 * this.m_linearJacobian.angular1 +
      m +
      p * this.m_linearJacobian.angular2 * this.m_linearJacobian.angular2;
    this.m_linearMass = 1 / this.m_linearMass;
    this.m_angularMass = 1 / (n + p);
    if (this.m_enableLimit || this.m_enableMotor)
      (e = a.m_R),
        (q = e.col1.x * this.m_localXAxis1.x + e.col2.x * this.m_localXAxis1.y),
        (e = e.col1.y * this.m_localXAxis1.x + e.col2.y * this.m_localXAxis1.y),
        (this.m_motorJacobian.linear1.x = -q),
        (this.m_motorJacobian.linear1.y = -e),
        (this.m_motorJacobian.linear2.x = q),
        (this.m_motorJacobian.linear2.y = e),
        (this.m_motorJacobian.angular1 = -(r * e - s * q)),
        (this.m_motorJacobian.angular2 = h * e - k * q),
        (this.m_motorMass =
          l +
          n * this.m_motorJacobian.angular1 * this.m_motorJacobian.angular1 +
          m +
          p * this.m_motorJacobian.angular2 * this.m_motorJacobian.angular2),
    ...
    b2World.s_enableWarmStarting
      ? ((f =
        ...
        (a.m_linearVelocity.y += l * f),
        (a.m_angularVelocity += n * k),
        (c.m_linearVelocity.x += m * g),
        (c.m_linearVelocity.y += m * h),
        (c.m_angularVelocity += p * r))
      : (this.m_motorImpulse =
          this.m_limitImpulse =
          this.m_angularImpulse =
          this.m_linearImpulse =
  ...
  SolveVelocityConstraints: function (a) {
    var c = this.m_body1,
      ...
      h = c.m_invI,
      k = e.m_invI,
      l = this.m_linearJacobian.Compute(
        c.m_linearVelocity,
        c.m_angularVelocity,
        e.m_linearVelocity,
        e.m_angularVelocity
    ...
    if (this.m_enableMotor && this.m_limitState != b2Joint.e_equalLimits) {
      ...
      this.m_motorImpulse = b2Math.b2Clamp(
        this.m_motorImpulse + l,
        -a.dt * this.m_maxMotorForce,
        a.dt * this.m_maxMotorForce
      );
    ...
    this.m_enableLimit &&
      this.m_limitState != b2Joint.e_inactiveLimit &&
      ((a = this.m_motorJacobian.Compute(
        c.m_linearVelocity,
        c.m_angularVelocity,
        e.m_linearVelocity,
        e.m_angularVelocity
      )),
      (l = -this.m_motorMass * a),
      this.m_limitState == b2Joint.e_equalLimits
        ? (this.m_limitImpulse += l)
        : this.m_limitState == b2Joint.e_atLowerLimit
        ? ((a = this.m_limitImpulse),
          (this.m_limitImpulse = b2Math.b2Max(this.m_limitImpulse + l, 0)),
          (l = this.m_limitImpulse - a))
        : this.m_limitState == b2Joint.e_atUpperLimit &&
          ((a = this.m_limitImpulse),
          (this.m_limitImpulse = b2Math.b2Min(this.m_limitImpulse + l, 0)),
          (l = this.m_limitImpulse - a)),
      (c.m_linearVelocity.x += f * l * this.m_motorJacobian.linear1.x),
      (c.m_linearVelocity.y += f * l * this.m_motorJacobian.linear1.y),
      (c.m_angularVelocity += h * l * this.m_motorJacobian.angular1),
  ...
  SolvePositionConstraints: function () {
    ...
    a = e.m_R;
    var r =
        (a.col1.x * this.m_localYAxis1.x + a.col2.x * this.m_localYAxis1.y) *
          (p - m) +
        (a.col1.y * this.m_localYAxis1.x + a.col2.y * this.m_localYAxis1.y) *
          (q - n),
      r = b2Math.b2Clamp(
        r,
        -b2Settings.b2_maxLinearCorrection,
    ...
    this.m_enableLimit &&
      this.m_limitState != b2Joint.e_inactiveLimit &&
      ((a = e.m_R),
      (m = a.col1.x * this.m_localAnchor1.x + a.col2.x * this.m_localAnchor1.y),
      (n = a.col1.y * this.m_localAnchor1.x + a.col2.y * this.m_localAnchor1.y),
      (a = f.m_R),
      (p = a.col1.x * this.m_localAnchor2.x + a.col2.x * this.m_localAnchor2.y),
      (a = a.col1.y * this.m_localAnchor2.x + a.col2.y * this.m_localAnchor2.y),
      (m = e.m_position.x + m),
      (n = e.m_position.y + n),
      (p = f.m_position.x + p),
      ...
      this.m_limitState == b2Joint.e_equalLimits
        ? ((a = b2Math.b2Clamp(
          ...
          (a *= -this.m_motorMass),
          (r = b2Math.b2Max(r, b2Math.b2Abs(c))))
        : this.m_limitState == b2Joint.e_atLowerLimit
        ? ((a = m - this.m_lowerTranslation),
          (r = b2Math.b2Max(r, -a)),
          (a = b2Math.b2Clamp(
          ...
          (this.m_limitPositionImpulse = b2Math.b2Max(
            this.m_limitPositionImpulse + a,
            0
          )),
          (a = this.m_limitPositionImpulse - c))
        : this.m_limitState == b2Joint.e_atUpperLimit &&
          ((a = m - this.m_upperTranslation),
          (r = b2Math.b2Max(r, a)),
          (a = b2Math.b2Clamp(
            a - b2Settings.b2_linearSlop,
            0,
          ...
          (a = this.m_limitPositionImpulse - c)),
      (e.m_position.x += g * a * this.m_motorJacobian.linear1.x),
      (e.m_position.y += g * a * this.m_motorJacobian.linear1.y),
      (e.m_rotation += k * a * this.m_motorJacobian.angular1),
      e.m_R.Set(e.m_rotation),
      (f.m_position.x += h * a * this.m_motorJacobian.linear2.x),
      (f.m_position.y += h * a * this.m_motorJacobian.linear2.y),
      (f.m_rotation += l * a * this.m_motorJacobian.angular2),
      f.m_R.Set(f.m_rotation));
...
Object.extend(b2PulleyJoint.prototype, {
  ...
  PrepareVelocitySolver: function () {
    ...
    this.m_u1.Set(
      a.m_position.x +
        f -
        (this.m_ground.m_position.x + this.m_groundAnchor1.x),
      a.m_position.y + g - (this.m_ground.m_position.y + this.m_groundAnchor1.y)
    );
    this.m_u2.Set(k - m, l - n);
    k = this.m_u1.Length();
    l = this.m_u2.Length();
    k > b2Settings.b2_linearSlop
      ? this.m_u1.Multiply(1 / k)
      : this.m_u1.SetZero();
    l > b2Settings.b2_linearSlop
      ? this.m_u2.Multiply(1 / l)
      : this.m_u2.SetZero();
    k < this.m_maxLength1
  ...
  SolveVelocityConstraints: function (a) {
    ...
    k =
      -(this.m_u1.x * k + this.m_u1.y * l) -
      this.m_ratio * (this.m_u2.x * m + this.m_u2.y * n);
    ...
    this.m_limitState1 == b2Joint.e_atUpperLimit &&
      ((k = a.m_linearVelocity.x + -a.m_angularVelocity * g),
      (l = a.m_linearVelocity.y + a.m_angularVelocity * f),
      (k = -(this.m_u1.x * k + this.m_u1.y * l)),
      (n = -this.m_limitMass1 * k),
      (k = this.m_limitImpulse1),
      (this.m_limitImpulse1 = b2Math.b2Max(0, this.m_limitImpulse1 + n)),
      (n = this.m_limitImpulse1 - k),
      (k = -n * this.m_u1.x),
      (l = -n * this.m_u1.y),
      (a.m_linearVelocity.x += a.m_invMass * k),
      (a.m_linearVelocity.y += a.m_invMass * l),
    ...
    this.m_limitState2 == b2Joint.e_atUpperLimit &&
      ((m = c.m_linearVelocity.x + -c.m_angularVelocity * e),
      (n = c.m_linearVelocity.y + c.m_angularVelocity * h),
      (k = -(this.m_u2.x * m + this.m_u2.y * n)),
      (n = -this.m_limitMass2 * k),
      (k = this.m_limitImpulse2),
      (this.m_limitImpulse2 = b2Math.b2Max(0, this.m_limitImpulse2 + n)),
      (n = this.m_limitImpulse2 - k),
      (m = -n * this.m_u2.x),
      (n = -n * this.m_u2.y),
      (c.m_linearVelocity.x += c.m_invMass * m),
      (c.m_linearVelocity.y += c.m_invMass * n),
  ...
  SolvePositionConstraints: function () {
    var a = this.m_body1,
      c = this.m_body2,
      e,
      f = this.m_ground.m_position.x + this.m_groundAnchor1.x,
    ...
    this.m_limitState1 == b2Joint.e_atUpperLimit &&
      ...
      (p = this.m_u1.Length()),
      p > b2Settings.b2_linearSlop
        ? ((this.m_u1.x *= 1 / p), (this.m_u1.y *= 1 / p))
        : this.m_u1.SetZero(),
      (p = this.m_maxLength1 - p),
      (t = b2Math.b2Max(t, -p)),
      (p = b2Math.b2Clamp(
        p + b2Settings.b2_linearSlop,
        -b2Settings.b2_maxLinearCorrection,
      ...
      (s = -this.m_limitMass1 * p),
      (f = this.m_limitPositionImpulse1),
      (this.m_limitPositionImpulse1 = b2Math.b2Max(
        0,
        this.m_limitPositionImpulse1 + s
      )),
      (s = this.m_limitPositionImpulse1 - f),
      (p = -s * this.m_u1.x),
      (q = -s * this.m_u1.y),
      (a.m_position.x += a.m_invMass * p),
      (a.m_position.y += a.m_invMass * q),
    ...
    this.m_limitState2 == b2Joint.e_atUpperLimit &&
      ...
      (q = this.m_u2.Length()),
      q > b2Settings.b2_linearSlop
        ? ((this.m_u2.x *= 1 / q), (this.m_u2.y *= 1 / q))
        : this.m_u2.SetZero(),
      (p = this.m_maxLength2 - q),
      (t = b2Math.b2Max(t, -p)),
      (p = b2Math.b2Clamp(
        p + b2Settings.b2_linearSlop,
        -b2Settings.b2_maxLinearCorrection,
      ...
      (s = -this.m_limitMass2 * p),
      (f = this.m_limitPositionImpulse2),
      (this.m_limitPositionImpulse2 = b2Math.b2Max(
        0,
        this.m_limitPositionImpulse2 + s
      )),
      (s = this.m_limitPositionImpulse2 - f),
      (r = -s * this.m_u2.x),
      (s = -s * this.m_u2.y),
      (c.m_position.x += c.m_invMass * r),
      (c.m_position.y += c.m_invMass * s),
...
Object.extend(b2RevoluteJoint.prototype, {
  ...
  PrepareVelocitySolver: function () {
    ...
    b2World.s_enableWarmStarting
      ? ((a.m_linearVelocity.x -= k * this.m_ptpImpulse.x),
        (a.m_linearVelocity.y -= k * this.m_ptpImpulse.y),
        (a.m_angularVelocity -=
          m *
          (f * this.m_ptpImpulse.y -
            g * this.m_ptpImpulse.x +
            this.m_motorImpulse +
            this.m_limitImpulse)),
        (c.m_linearVelocity.x += l * this.m_ptpImpulse.x),
        (c.m_linearVelocity.y += l * this.m_ptpImpulse.y),
        (c.m_angularVelocity +=
          n *
          (h * this.m_ptpImpulse.y -
  ...
  SolveVelocityConstraints: function (a) {
    ...
    this.m_enableMotor &&
      ...
      ((g =
        -this.m_motorMass *
        (e.m_angularVelocity - c.m_angularVelocity - this.m_motorSpeed)),
      (h = this.m_motorImpulse),
      (this.m_motorImpulse = b2Math.b2Clamp(
        this.m_motorImpulse + g,
        -a.dt * this.m_maxMotorTorque,
        a.dt * this.m_maxMotorTorque
      )),
      (g = this.m_motorImpulse - h),
      (c.m_angularVelocity -= c.m_invI * g),
      (e.m_angularVelocity += e.m_invI * g));
    this.m_enableLimit &&
      this.m_limitState != b2Joint.e_inactiveLimit &&
      ((g = -this.m_motorMass * (e.m_angularVelocity - c.m_angularVelocity)),
      this.m_limitState == b2Joint.e_equalLimits
  ...
  SolvePositionConstraints: function () {
    ...
    this.m_enableLimit &&
      this.m_limitState != b2Joint.e_inactiveLimit &&
      ((a = e.m_rotation - c.m_rotation - this.m_intialAngle),
      (h = 0),
      this.m_limitState == b2Joint.e_equalLimits
        ? ((a = b2Math.b2Clamp(
            a,
          ...
          (h = -this.m_motorMass * a),
          (g = b2Math.b2Abs(a)))
        : this.m_limitState == b2Joint.e_atLowerLimit
        ? ((a -= this.m_lowerAngle),
          (g = b2Math.b2Max(0, -a)),
          (a = b2Math.b2Clamp(
            a + b2Settings.b2_angularSlop,
            -b2Settings.b2_maxAngularCorrection,
            0
          )),
          (h = -this.m_motorMass * a),
          ...
          (this.m_limitPositionImpulse = b2Math.b2Max(
            this.m_limitPositionImpulse + h,
            0
          )),
          (h = this.m_limitPositionImpulse - a))
        : this.m_limitState == b2Joint.e_atUpperLimit &&
          ((a -= this.m_upperAngle),
          (g = b2Math.b2Max(0, a)),
          (a = b2Math.b2Clamp(
          ...
          (h = this.m_limitPositionImpulse - a)),
      (c.m_rotation -= c.m_invI * h),
      c.m_R.Set(c.m_rotation),
      (e.m_rotation += e.m_invI * h),
      e.m_R.Set(e.m_rotation));
...
function drawJoint(a, c, e, f) {
  ...
  switch (c.m_type) {
    ...
    default:
      g == a.m_groundBody
        ? e.drawLine(m.x, m.y, l.x, l.y, 1, f)
        : h == a.m_groundBody
        ? e.drawLine(m.x, m.y, k.x, k.y, 1, f)
        : (e.drawLine(k.x, k.y, m.x, m.y, 1, f),
          e.drawLine(m.x, m.y, l.x, l.y, 1, f),
          e.drawLine(l.x, l.y, n.x, n.y, 1, f));
  }
}
function drawShape(a, c) {
  switch (a.m_type) {
    ...
    case b2Shape.e_polyShape:
      ...
      k = e.x;
      l = e.y;
      for (m = 0; m < a.m_vertexCount; m++)
        (n = b2Math.AddVV(
          a.m_position,
          b2Math.b2MulMV(a.m_R, a.m_vertices[m])
        )),
...
function SimpleText(a, c, e) {
  ...
  this.write = function (a) {
    ...
    this.align == this.ALIGN_CENTER &&
      (c =
        ...
        this.getCharWidth(this.text.substr(0, 1)) / 2);
    this.align == this.ALIGN_RIGHT &&
      (c = this.x - this.getWidth() * this.scale);
    ...
    for (var m = 0; m < a.length; m++)
      if (
        ...
        this.sprites[m].scaleX = this.sprites[m].scaleY = this.scale;
        this.sprites[m].gotoAndStop(l);
        l = k.clone();
        l.x *= this.scale;
        l.rotate(-this.rotation);
        this.sprites[m].x =
          l.x + ("," == this.text.substr(m, 1) ? c - n / 2 : c);
  ...
  this.addToGroup = function (a) {
    for (var c = 0; c < this.sprites.length; c++)
      (this.sprites[c].gx = this.sprites[c].x / 2),
        (this.sprites[c].gy = this.sprites[c].y),
        a.addChild(this.sprites[c], !1);
  };
}
function AudioPlayer() {
  ...
  this.init = function (a) {
    ...
    a.canPlayType
      ? (this.mp3Support = "" != a.canPlayType("audio/mpeg"))
      : (this.disabled = !0);
    ...
    if (AudioMixer.isWebAudioSupport()) {
      ...
      this.loadSound(f, function (a) {
        ...
        g.waCheckInterval = setInterval(function () {
          g.audioWrapper
            ? g.audioWrapper.playbackState == g.audioWrapper.FINISHED_STATE &&
              g.controlPlay()
            : clearInterval(g.waCheckInterval);
        }, 100);
      });
    } else
      (this.audioWrapper.src = f),
  ...
  this.loadSound = function (a, e) {
    if (AudioMixer.buffer[a]) e && e(AudioMixer.buffer[a]);
    else {
  ...
  this.pause = function () {
    AudioMixer.isWebAudioSupport()
      ? a.audioWrapper && a.audioWrapper.disconnect()
      : this.audioWrapper.pause();
  };
  this.resume = function () {
    AudioMixer.isWebAudioSupport()
      ? a.audioWrapper &&
        a.audioWrapper.connect(AudioMixer.waContext.destination)
      : this.audioWrapper.play();
  };
  this.controlPlay = function () {
    if (a.audioWrapper.doLoop)
      ...
      a.busy = !1;
      if ("function" == typeof a.onend) a.onend();
...
function AudioMixer(a, c) {
  ...
  this.init = function (a, c) {
    ...
    "undefined" !== typeof document.hidden
      ? ((h = "hidden"), (k = "visibilitychange"))
      : "undefined" !== typeof document.mozHidden
      ? ((h = "mozHidden"), (k = "mozvisibilitychange"))
      : "undefined" !== typeof document.msHidden
      ? ((h = "msHidden"), (k = "msvisibilitychange"))
    ...
    document.addEventListener(
      ...
      function () {
        if (document[h])
          for (var a = 0; a < l.channels.length; a++) l.channels[a].pause();
        else for (a = 0; a < l.channels.length; a++) l.channels[a].resume();
      },
      !1
    );
  };
  this.play = function (a, c, g, h) {
    var k = -1,
      k = "number" == typeof h ? h : this.getFreeChannel(g);
    0 <= k &&
      k < this.channels.length &&
      (this.channels[k].stop(), this.channels[k].play(a, c));
  ...
  this.getFreeChannel = function (a) {
    for (
      var c = -1, g = [], h = -1, k = -1, l = 0, m = 0;
      m < this.channels.length;
      m++
    )
      this.channels[m].locked ||
        (this.channels[m].busy
          ? ((l = new Date().getTime()),
            (l -= this.channels[m].startPlayTime),
            l > k && ((k = l), (h = m)))
          : g.push(m));
...
function TilesSprite(a, c, e, f, g, h) {
  ...
  this.changeStep = function (a) {
    a = a.target;
    a.animated &&
      a.animStep + 1 >= a.animDelay &&
      (a.currentFrameX++,
      a.currentFrameX >= a.framesCount && (a.currentFrameX = 0));
  };
...
var levels = [
    {
      objects: [
        { type: "tube1", x: 20, y: 197, rotation: 0 },
        { type: "tube2", x: 460, y: 197, rotation: 0 },
        { type: "invisible_wall_big", x: 62, y: 231, rotation: 0 },
        { type: "invisible_wall_big", x: 212, y: 231, rotation: 0 },
        {
        ...
        { type: "invisible_wall_small", x: 238, y: 112, rotation: 0 },
        { type: "invisible_wall_small", x: 266, y: 112, rotation: 0 },
        {
        ...
        { type: "invisible_wall_big", x: 363, y: 231, rotation: 0 },
        { type: "invisible_wall_small", x: 462, y: 231, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 169,
          y: 35,
          rotation: -0.39999999999999997,
          restitution: 0.4,
        },
        { type: "button_red", x: 173, y: 263, rotation: 0 },
        { type: "trap", x: 270, y: 208, rotation: 0 },
        { type: "earth_lvl1", x: 165, y: 225, rotation: 0 },
        { type: "fan", x: 173, y: 152, rotation: 0 },
        { type: "lever", x: 250, y: 167, rotation: 0 },
        { type: "tip1", x: 85, y: 112, rotation: 0 },
        { type: "tip2", x: 360, y: 50, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 29, y: 128, rotation: 0 },
        { type: "tube2", x: 460, y: 80, rotation: 0 },
        { type: "invisible_wall_big", x: 68, y: 161, rotation: 0 },
        { type: "invisible_wall_big", x: 500, y: 115, rotation: 0 },
        { type: "invisible_wall_big", x: 145, y: 161, rotation: 0 },
        { type: "invisible_wall_small", x: 313, y: 161, rotation: 0 },
        { type: "invisible_wall_small", x: 329, y: 161, rotation: 0 },
        { type: "invisible_wall_small", x: 208, y: 178, rotation: 0 },
        { type: "invisible_wall_small", x: 306, y: 178, rotation: 0 },
        { type: "invisible_wall_big", x: 404, y: 37, rotation: 0 },
        { type: "invisible_wall_big", x: 305, y: 37, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 239,
          y: 14,
        ...
        { type: "invisible_wall_big", x: 426, y: 190, rotation: 1.5708 },
        { type: "button_red", x: 449, y: 148, rotation: 0 },
        { type: "Lift", x: 391, y: 205, rotation: 0 },
        { type: "btn2", x: 257, y: 35, rotation: 0 },
        { type: "bridge_lvl2", x: 256, y: 68, rotation: 0 },
        { type: "ButtonSystem", x: 258, y: 55, rotation: 0 },
        { type: "bollMc", x: 472, y: 13, rotation: 0 },
        { type: "Fire", x: 259, y: 249, rotation: 0 },
        { type: "Neutral1", x: 216, y: 221, rotation: 0 },
        { type: "Neutral2", x: 293, y: 233, rotation: 0 },
        { type: "Lvl2_Hint1", x: 135, y: 55, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 153, y: 15, rotation: 1.5707963267948966 },
        { type: "tube2", x: 461, y: 123, rotation: 0 },
        { type: "invisible_wall_big", x: 83, y: 156, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 60,
          y: 142,
        ...
        { type: "invisible_wall_big", x: 301, y: 156, rotation: 0 },
        { type: "invisible_wall_big", x: 431, y: 156, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 156,
          y: 230,
        ...
        { type: "fence", x: 370, y: 123, rotation: 0 },
        { type: "btn", x: 80, y: 152, rotation: 0 },
        {
          type: "bridge_lvl3",
          x: 176,
          y: 161,
        ...
        { type: "earth1_lvl3", x: 141, y: 160, rotation: 0 },
        { type: "earth2_lvl3", x: 242, y: 160, rotation: 0 },
        { type: "btn_lvl3_red", x: 121.5, y: 183.5, rotation: 0 },
        { type: "btn_lvl3_red", x: 140.5, y: 208.5, rotation: 0 },
        { type: "btn_lvl3_green", x: 121.5, y: 232.5, rotation: 0 },
        { type: "btn_lvl3_red", x: 137.5, y: 259.5, rotation: 0 },
        { type: "btn_lvl3_red", x: 262, y: 183, rotation: 0 },
        { type: "btn_lvl3_red", x: 243, y: 208.5, rotation: 0 },
        { type: "btn_lvl3_red", x: 262, y: 232, rotation: 0 },
        { type: "btn_lvl3_red", x: 246, y: 259, rotation: 0 },
        { type: "numbers_lvl3", x: 193, y: 221, rotation: 0 },
        { type: "doors_lvl3", x: 193, y: 222, rotation: 0 },
        { type: "exit", x: 393, y: 136, rotation: 0 },
        { type: "terminator_appear", x: 340, y: 141, rotation: 0 },
        { type: "lava_lvl3", x: 191.5, y: 274, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 19, y: 202, rotation: 0 },
        { type: "tube2", x: 468, y: 204, rotation: 0 },
        { type: "invisible_wall_big", x: 440, y: 237, rotation: 0 },
        { type: "invisible_wall_big", x: 33, y: 237, rotation: 0 },
        { type: "invisible_wall_big", x: 29, y: 114, rotation: 0 },
        { type: "invisible_wall_big", x: 178, y: 114, rotation: 0 },
        { type: "lever", x: 130, y: 75, rotation: 0, custom: "no_cover" },
        { type: "invisible_wall_big", x: 453, y: 62, rotation: 0 },
        { type: "invisible_wall_big", x: 454, y: 113, rotation: 0 },
        { type: "invisible_wall_big", x: 455, y: 165, rotation: 0 },
        { type: "btn", x: 433, y: 58, rotation: 0 },
        { type: "btn", x: 433, y: 110, rotation: 0 },
        { type: "btn", x: 433, y: 162, rotation: 0 },
        { type: "earth_move", x: 134, y: 346, rotation: 0, custom: "earth1" },
        { type: "earth_fixed", x: 186, y: 278, rotation: 0 },
        { type: "earth_move", x: 237, y: 277, rotation: 0, custom: "earth2" },
        { type: "earth_fixed", x: 289, y: 278, rotation: 0 },
        { type: "earth_move", x: 339, y: 346, rotation: 0, custom: "earth3" },
        { type: "bridge_lvl4", x: 313, y: 117, rotation: 0 },
        { type: "hose", x: 210, y: 30, rotation: 0 },
        { type: "antiant_anim", x: 217, y: 79, rotation: 0 },
        { type: "log_lvl4", x: 128, y: 139, rotation: 0, custom: 3 },
        { type: "btn3", x: 163, y: 133, rotation: 0, custom: 1 },
        { type: "btn3", x: 194, y: 133, rotation: 0, custom: 2 },
        { type: "btn3", x: 225, y: 133, rotation: 0, custom: 3 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 23, y: 67, rotation: 0 },
        { type: "tube2", x: 456, y: 222, rotation: 0 },
        { type: "invisible_wall_big", x: 55, y: 101, rotation: 0 },
        { type: "invisible_wall_big", x: 100, y: 194, rotation: 0 },
        { type: "invisible_wall_big", x: 250, y: 194, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 442,
          y: 194,
        ...
        { type: "invisible_wall_big", x: 447, y: 257, rotation: 0 },
        { type: "invisible_wall_big", x: 64, y: 190, rotation: 0.35 },
        { type: "fireball", x: 50, y: 150, rotation: 0 },
        { type: "moving_fence", x: 83, y: 188, rotation: 0 },
        { type: "earth2_lvl5", x: 78, y: 202, rotation: 0 },
        { type: "btn2", x: 184, y: 190, rotation: 0 },
        { type: "bridge_lvl5", x: 292, y: 262, rotation: 0, density: 0 },
        { type: "earth1_lvl5", x: 284.5, y: 261, rotation: 0, density: 0 },
        {
          type: "lever",
          x: 286,
          y: 235,
        ...
        { type: "Lvl5_Hint1", x: 240, y: 55, rotation: 0 },
        { type: "arrow_hint5", x: 125, y: 40, rotation: 0.25 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 15, y: 197, rotation: 0, custom: !0 },
        { type: "tube2", x: 474, y: 198, rotation: 0 },
        { type: "invisible_wall_big", x: 60, y: 231.5, rotation: 0 },
        { type: "invisible_wall_big", x: 135, y: 231.5, rotation: 0 },
        { type: "invisible_wall_big", x: 132, y: 135.5, rotation: 0 },
        { type: "invisible_wall_small", x: 182, y: 140.5, rotation: 0 },
        { type: "invisible_wall_small", x: 182, y: 145.5, rotation: 0 },
        { type: "invisible_wall_small", x: 182, y: 150.5, rotation: 0 },
        { type: "invisible_wall_small", x: 303, y: 230, rotation: 0 },
        { type: "invisible_wall_small", x: 323, y: 230, rotation: 0 },
        { type: "invisible_wall_big", x: 470, y: 231, rotation: 0 },
        { type: "invisible_wall_big", x: 397, y: 305, rotation: Math.PI / 2 },
        { type: "lift_lvl6", x: 243, y: 329, rotation: 0 },
        { type: "spring_lvl6", x: 27, y: 98, rotation: Math.PI / 2 },
        { type: "btn2", x: 88, y: 135, rotation: 0 },
        { type: "lever", x: 182, y: 270, rotation: Math.PI / 2 },
        { type: "bridge_lvl6", x: 371, y: 235, rotation: 0 },
        { type: "earth_lvl6", x: 313, y: 238, rotation: 0 },
        { type: "button_red", x: 109, y: 71.5, rotation: 0 },
        {
          type: "indicator_lvl6",
          x: 90,
          y: 149,
          rotation: 0,
          custom: "indicator_left",
        },
        {
          type: "indicator_lvl6",
          x: 333,
          y: 237,
          rotation: 0,
          custom: "indicator_right",
        },
        { type: "caterpillar", x: 340, y: 202, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube2", x: 460, y: 214, rotation: 0 },
        { type: "tube1", x: 21, y: 143, rotation: 0 },
        { type: "invisible_wall_small", x: 39, y: 177, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 61,
          y: 204,
        ...
        { type: "invisible_wall_big", x: 139, y: 221, rotation: 0 },
        { type: "invisible_wall_small", x: 238, y: 221, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 260,
          y: 294,
        ...
        { type: "invisible_wall_big", x: 420, y: 248, rotation: 0 },
        { type: "lever", x: 387, y: 145, rotation: 1.5707963267948966 },
        { type: "button_red", x: 137, y: 40, rotation: 0 },
        { type: "magnet", x: 86, y: 76, rotation: 0 },
        { type: "stripes", x: 86, y: 90, rotation: -0.5 },
        { type: "stripes", x: 96, y: 86, rotation: -0.5 },
        { type: "wire_lvl7", x: 91, y: 34, rotation: 0 },
        { type: "bridge_lvl7", x: 354, y: 217, rotation: 0 },
        { type: "earth_lvl7", x: 354, y: 277, rotation: 0 },
        { type: "ball_holder", x: 225, y: 27, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 257, y: 10, rotation: 1.5707963267948966 },
        { type: "tube2", x: 466, y: 234, rotation: 0 },
        { type: "invisible_wall_big", x: 267, y: 95, rotation: 0 },
        { type: "invisible_wall_big", x: 438, y: 95, rotation: 0 },
        { type: "invisible_wall_big", x: 86, y: 206, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 39,
          y: 132,
          rotation: 1.5009831567151233,
        },
        { type: "invisible_wall_big", x: 260, y: 264, rotation: 0 },
        { type: "invisible_wall_big", x: 410, y: 264, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 205,
          y: 116,
        ...
        { type: "skeleton", x: 325, y: 155, rotation: 0 },
        { type: "box_lvl8", x: 320, y: 150, rotation: 0 },
        { type: "spring_lvl8", x: 171, y: 225, rotation: 1.5707963267948966 },
        { type: "slider", x: 325, y: 34, rotation: 0 },
        { type: "Baraban", x: 325, y: 103, rotation: 0 },
        { type: "electricity_10", x: 400, y: 93, rotation: 0 },
        {
        ...
        { type: "button_blue_mid", x: 87, y: 86, rotation: 0 },
        { type: "button_red", x: 130, y: 235, rotation: 0 },
        { type: "bridge2_lvl8", x: 118, y: 159, rotation: Math.PI / 6 },
        { type: "link_lvl8", x: 118, y: 159, rotation: 0 },
        { type: "bridge_lvl8", x: 204, y: 159, rotation: 0 },
        { type: "earth_lvl8", x: 210, y: 108, rotation: 0 },
        { type: "link_lvl8", x: 204, y: 122, rotation: 0 },
        { type: "btn2", x: 46, y: 171, rotation: 1.5707963267948966 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 27, y: 120, rotation: 0 },
        { type: "tube2", x: 460, y: 169, rotation: 0 },
        { type: "trampoline", x: 143, y: 256, rotation: 0 },
        ...
        { type: "invisible_wall_big", x: 446, y: 204, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 372,
          y: 278,
        ...
        { type: "lever", x: 282, y: 36, rotation: 0 },
        { type: "bbq", x: 214, y: 70, rotation: 0 },
        { type: "fly_lvl9", x: 248, y: 78, rotation: 0 },
        { type: "fly_lvl9", x: 181, y: 78, rotation: 0 },
        { type: "fire_lvl9", x: 215, y: 107, rotation: 0 },
        {
          type: "button_blue_down",
          x: 38,
          y: 233,
        ...
        { type: "button_blue_mid", x: 58, y: 233, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 15, y: 105, rotation: 0 },
        { type: "tube2", x: 467, y: 78, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 60,
          y: 215,
        ...
        { type: "invisible_wall_small", x: 37, y: 141, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 136,
          y: 120,
        ...
        { type: "invisible_wall_small", x: 161, y: 249, rotation: 0 },
        { type: "invisible_wall_small", x: 179, y: 249, rotation: 0 },
        { type: "invisible_wall_small", x: 163, y: 193, rotation: 0 },
        { type: "invisible_wall_small", x: 184, y: 193, rotation: 0 },
        { type: "invisible_wall_small", x: 184, y: 185, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 215,
          y: 100,
        ...
        { type: "invisible_wall_big", x: 207, y: 23, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 360,
          y: 47,
        ...
        { type: "invisible_wall_small", x: 303, y: 84, rotation: -0.05 },
        {
          type: "invisible_wall_big",
          x: 283,
          y: 238,
        ...
        { type: "invisible_wall_big", x: 137, y: 250, rotation: 0 },
        { type: "invisible_wall_big", x: 286, y: 250, rotation: 0 },
        { type: "invisible_wall_small", x: 386, y: 250, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 393,
          y: 185,
        ...
        { type: "invisible_wall_big", x: 465, y: 113, rotation: 0 },
        { type: "fan_lvl10", x: 190, y: 10, rotation: 0 },
        { type: "earth_lvl10", x: 188, y: 15, rotation: 0 },
        { type: "fan", x: 98, y: 172, rotation: 0, custom: "fan1" },
        { type: "fan", x: 245, y: 172, rotation: 0, custom: "fan2" },
        { type: "fan", x: 355, y: 172, rotation: 0, custom: "fan3" },
        {
          type: "fan",
          x: 289,
          y: 58,
    ...
    {
      objects: [
        { type: "danger", x: 278, y: 36, rotation: 0 },
        { type: "btn2", x: 246, y: 273, rotation: 0 },
        { type: "wall1", x: 14, y: 234, rotation: 0 },
        { type: "wall2", x: 479, y: 233, rotation: 0 },
        { type: "tube1", x: 31, y: 112, rotation: 0, custom: !0 },
        { type: "tube2", x: 450, y: 112, rotation: 0 },
        { type: "invisible_wall_big", x: 53, y: 147, rotation: 0 },
        { type: "invisible_wall_big", x: 151, y: 258, rotation: 0 },
        { type: "invisible_wall_small", x: 249, y: 274, rotation: 0 },
        { type: "invisible_wall_small", x: 224, y: 281, rotation: Math.PI / 2 },
        { type: "invisible_wall_small", x: 270, y: 281, rotation: Math.PI / 2 },
        { type: "invisible_wall_big", x: 343, y: 258, rotation: 0 },
        { type: "invisible_wall_big", x: 442, y: 147, rotation: 0 },
        { type: "dart", x: 145, y: 41, rotation: 0 },
        { type: "ant_lvl11", x: 101, y: 40, rotation: 0 },
        { type: "cannon", x: 134, y: 56, rotation: 0 },
        { type: "button_red", x: 123, y: 70, rotation: 0, custom: "dont_hint" },
        { type: "flap", x: 123, y: 70, rotation: 0 },
        {
          type: "button_blue_down",
          x: 332,
          y: 73,
        ...
        { type: "earth_lvl11", x: 240, y: 232, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 21, y: 114, rotation: 0 },
        { type: "tube2", x: 449, y: 113, rotation: 0 },
        { type: "invisible_wall_big", x: 45, y: 147, rotation: 0 },
        { type: "invisible_wall_big", x: 133, y: 269, rotation: 0 },
        { type: "invisible_wall_small", x: 191, y: 282, rotation: 0 },
        { type: "invisible_wall_small", x: 288, y: 282, rotation: 0 },
        { type: "invisible_wall_big", x: 345, y: 273, rotation: 0 },
        { type: "invisible_wall_big", x: 401, y: 145, rotation: 0 },
        { type: "invisible_wall_small", x: 452, y: 94, rotation: 0 },
        { type: "invisible_wall_big", x: 188, y: 53, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 267,
          y: 25,
        ...
        { type: "invisible_wall_big", x: 344, y: 24, rotation: 0 },
        { type: "invisible_wall_small", x: 444, y: 24, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 451,
          y: 48,
        ...
        { type: "invisible_wall_small", x: 300, y: 200, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 328,
          y: 173,
        ...
        { type: "trap", x: 90, y: 249, rotation: 0 },
        { type: "electricity_10", x: 290, y: 269, rotation: 0 },
        {
        ...
        { type: "button_blue_down", x: 215, y: 38, rotation: 0 },
        {
          type: "button_blue_left",
          x: 243,
          y: 38,
        ...
        { type: "lever", x: 81, y: 191, rotation: 0 },
        { type: "pump_up", x: 376, y: 215, rotation: 0 },
        { type: "pump_down", x: 377, y: 253, rotation: 0 },
        { type: "box_lvl12", x: 417, y: 55, rotation: 0 },
        { type: "crane", x: 417, y: 35, rotation: 0 },
        { type: "ball1", x: 240, y: 224, rotation: 0 },
        { type: "basket_invisible", x: 240, y: 273, rotation: 0 },
      ],
      joints: [
        { type: 0, point1: { x: 212, y: 266 } },
        { type: 0, point1: { x: 266, y: 266 } },
      ],
    },
    {
      objects: [
        { type: "tube1", x: 14, y: 189, rotation: 0 },
        { type: "tube2", x: 470, y: 186, rotation: 0 },
        { type: "invisible_wall_big", x: 59, y: 223, rotation: 0 },
        { type: "invisible_wall_small", x: 109, y: 240, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 130,
          y: 288,
        ...
        { type: "invisible_wall_small", x: 153, y: 294, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 158,
          y: 249,
        ...
        { type: "invisible_wall_small", x: 178, y: 222, rotation: 0 },
        { type: "invisible_wall_small", x: 197, y: 222, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 220,
          y: 295,
        ...
        { type: "invisible_wall_big", x: 449, y: 221, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 378,
          y: 295,
        ...
        { type: "invisible_wall_big", x: -50, y: 73, rotation: 0 },
        { type: "invisible_wall_big", x: 99, y: 73, rotation: 0 },
        { type: "invisible_wall_big", x: 268, y: 73, rotation: 0 },
        { type: "invisible_wall_big", x: 375, y: 73, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 445,
          y: 47,
        ...
        { type: "invisible_wall_small", x: 467, y: 119, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 172,
          y: 45,
        ...
        { type: "latch1", x: 195, y: 80, rotation: 0 },
        { type: "latch2", x: 123, y: 259, rotation: 0 },
        { type: "log_lvl13", x: 144, y: 209, rotation: 0 },
        { type: "btn2", x: 271, y: 76, rotation: 3.141592653589793 },
        { type: "trolley_play", x: 271, y: 65, rotation: 0 },
        {
          type: "button_red",
          x: 343,
          y: 53,
        ...
        { type: "spring_lvl8", x: 429, y: 87, rotation: -1.5707963267948966 },
        { type: "bridge_lvl13", x: 312, y: 40, rotation: 0 },
        { type: "trolley", x: 342, y: 230, rotation: 0 },
        { type: "trolley_play", x: 342, y: 228, rotation: 0 },
        { type: "earth_lvl13", x: 312, y: 39, rotation: 0 },
        { type: "beetle", x: -50, y: 90, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 26, y: 70, rotation: 0 },
        { type: "tube2", x: 449, y: 243, rotation: 0 },
        { type: "invisible_wall_big", x: 69, y: 101, rotation: 0 },
        { type: "invisible_wall_big", x: 115, y: 167, rotation: 0 },
        { type: "invisible_wall_big", x: -31, y: 167, rotation: 0 },
        { type: "invisible_wall_small", x: 262, y: 168, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 192,
          y: 245,
        ...
        { type: "invisible_wall_small", x: 213, y: 275, rotation: 0 },
        { type: "invisible_wall_big", x: 352, y: 277, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 277,
          y: 240,
        ...
        { type: "invisible_wall_big", x: 455, y: 277, rotation: 0 },
        { type: "invisible_wall_big", x: 472, y: 89, rotation: 0 },
        { type: "invisible_wall_small", x: 371, y: 167, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 348,
          y: 192,
        ...
        { type: "bridge_lvl14", x: 381, y: 175, rotation: 0 },
        { type: "earth_lvl14", x: 381.5, y: 175, rotation: 0 },
        { type: "lever", x: 369, y: 212, rotation: 0, custom: "no_static" },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 294, y: 248, rotation: 0 },
        { type: "tube2", x: 470, y: 118, rotation: 0 },
        { type: "invisible_wall_big", x: 145, y: 283, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 236,
          y: 257,
        ...
        { type: "Lift", x: 369.5, y: 372, rotation: 0 },
        { type: "invisible_wall_small", x: 245, y: 283, rotation: 0 },
        { type: "invisible_wall_small", x: 295, y: 283, rotation: 0 },
        { type: "invisible_wall_small", x: 310, y: 283, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 401,
          y: 223,
        ...
        { type: "invisible_wall_big", x: 474, y: 151, rotation: 0 },
        { type: "wheel", x: 179, y: 92, rotation: 0 },
        { type: "toy3", x: 178, y: 55, rotation: 0 },
        { type: "toy4", x: 224.5, y: 83.5, rotation: 0 },
        { type: "toy2", x: 178.5, y: 135.5, rotation: 0 },
        { type: "toy1", x: 133, y: 93, rotation: 0 },
        {
          type: "lever",
          x: 79,
          y: 61,
          rotation: 3.141592653589793,
          custom: "no_static_no_cover",
        },
        {
          type: "button_blue_down",
          x: 78,
        ...
        { type: "button_red", x: 423.5, y: 184, rotation: 0 },
        { type: "hunter1", x: 61, y: 203, rotation: 0 },
        { type: "earth_lvl15", x: 261, y: 255, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 127, y: 240, rotation: 0 },
        { type: "tube2", x: 453, y: 239, rotation: 0 },
        { type: "invisible_wall_big", x: 168, y: 274, rotation: 0 },
        { type: "invisible_wall_big", x: 318, y: 274, rotation: 0 },
        { type: "invisible_wall_big", x: 468, y: 274, rotation: 0 },
        { type: "invisible_wall_big", x: 27, y: 126, rotation: 0 },
        { type: "lever", x: 195, y: 35, rotation: 1.5707963267948966 },
        { type: "bridge1_lvl16", x: 159, y: 60, rotation: 0 },
        { type: "cover_lvl16", x: 159, y: 2, rotation: 0 },
        { type: "button_red", x: 68, y: 164, rotation: 0 },
        { type: "bridge2_lvl16", x: 65, y: 132, rotation: 0 },
        { type: "earth_lvl16", x: 59, y: 134, rotation: 0 },
        { type: "extraterrestrial", x: 124, y: 186, rotation: 0 },
        { type: "invisible_wall_big", x: 182, y: 206, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 283,
          y: 209,
        ...
        { type: "ufo_light", x: 361, y: 198, rotation: 0 },
        {
          type: "teleport_orange",
          x: 227,
          y: 175,
          rotation: 0,
          custom: "teleport11",
        ...
        { type: "back_orange1", x: 259, y: 174, rotation: 0 },
        { type: "back_orange2", x: 52, y: 47, rotation: 0 },
        { type: "back_blue1", x: 195, y: 100, rotation: 0 },
        { type: "back_blue2", x: 285, y: 123, rotation: 0 },
        { type: "ufo", x: 361, y: 104, rotation: 0 },
        { type: "invisible_wall_small", x: 198, y: 127, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 30, y: 134, rotation: 0 },
        { type: "tube2", x: 448, y: 94, rotation: 0 },
        { type: "invisible_wall_big", x: 139, y: 167, rotation: 0 },
        { type: "invisible_wall_big", x: -11, y: 167, rotation: 0 },
        { type: "invisible_wall_big", x: 356, y: 125, rotation: 0 },
        { type: "invisible_wall_big", x: 505, y: 125, rotation: 0 },
        { type: "invisible_wall_big", x: 139, y: 249, rotation: 0 },
        { type: "invisible_wall_big", x: -11, y: 249, rotation: 0 },
        { type: "invisible_wall_small", x: 309, y: 249, rotation: 0 },
        { type: "Lift", x: 248, y: 337, rotation: 0 },
        { type: "invisible_wall_big", x: 469, y: 249, rotation: 0 },
        { type: "invisible_wall_small", x: 441, y: 190, rotation: 1.3 },
        { type: "invisible_wall_small", x: 473, y: 222, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 280,
          y: 153,
        ...
        { type: "invisible_wall_big", x: 376, y: 157, rotation: 0 },
        { type: "shutter", x: 246, y: 36, rotation: 0 },
        { type: "shutter", x: 371, y: 36, rotation: 0 },
        { type: "holder", x: 250, y: -2, rotation: 0 },
        { type: "holder", x: 367, y: -2, rotation: 0 },
        { type: "bridge_lvl17", x: 288, y: 38, rotation: 0 },
        { type: "bridge_lvl17", x: 329, y: 38, rotation: 0 },
        { type: "button_red", x: 250, y: 37, rotation: 0, custom: "button0" },
        { type: "button_red", x: 367, y: 37, rotation: 0, custom: "button1" },
        { type: "btn2", x: 162, y: 164, rotation: 0 },
        { type: "btn2", x: 193, y: 251, rotation: 0 },
        { type: "button_green", x: 368, y: 162, rotation: 0 },
        { type: "spring_lvl17", x: 367, y: 259, rotation: 0 },
        {
          type: "button_red",
          x: 367,
          y: 278,
          rotation: 0,
          custom: "button_spring",
        },
        { type: "thing_with_lamps", x: 310, y: 9, rotation: 0 },
        { type: "caterpillar", x: -50, y: 235, rotation: 0 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "entrance_lvl18", x: 107, y: 201, rotation: 0 },
        { type: "tube2", x: 448, y: 200, rotation: 0 },
        { type: "invisible_wall_big", x: 78, y: 233, rotation: 0 },
        {
          type: "invisible_wall_small",
          x: 153,
          y: 257,
        ...
        { type: "invisible_wall_small", x: 218, y: 298, rotation: 1.5 },
        { type: "invisible_wall_small", x: 246, y: 298, rotation: -1.5 },
        {
          type: "invisible_wall_small",
          x: 74,
          y: 137,
        ...
        { type: "invisible_wall_big", x: 385, y: 233, rotation: 0 },
        { type: "invisible_wall_small", x: 485, y: 233, rotation: 0 },
        { type: "saw", x: 355, y: 145, rotation: 0 },
        { type: "log1_lvl18", x: 322, y: 80, rotation: -0.2 },
        { type: "locker", x: 75, y: 99, rotation: 0 },
        { type: "bollMc", x: 77, y: 93, rotation: 0, friction: 0.31 },
        { type: "tree", x: 148, y: 165, rotation: 0.56 },
        { type: "woodpecker", x: 181, y: 48, rotation: 0 },
        { type: "question_mark", x: 235, y: 20, rotation: 0 },
        { type: "bough", x: 146, y: 24, rotation: 0 },
        { type: "tree", x: 233, y: 337, rotation: Math.PI / 2 },
        { type: "tree", x: 218, y: 303, rotation: Math.PI / 2 },
        { type: "tree", x: 247, y: 303, rotation: Math.PI / 2 },
      ],
      joints: [],
    },
    {
      objects: [
        { type: "tube1", x: 31, y: 178, rotation: 0, custom: "true" },
        { type: "invisible_wall_big", x: 50, y: 211, rotation: 0 },
        { type: "invisible_wall_big", x: 448, y: 275, rotation: 0 },
        { type: "invisible_wall_small", x: 279, y: 82, rotation: 0 },
        { type: "invisible_wall_big", x: 323, y: 71, rotation: -0.33 },
        {
          type: "invisible_wall_big",
          x: 187,
          y: 283,
        ...
        { type: "lift_lvl19", x: 135, y: 12, rotation: 0 },
        { type: "tube2_lvl19", x: 430, y: 125, rotation: 0 },
        { type: "tube1_lvl19", x: 435, y: 227, rotation: 0, custom: !0 },
        {
          type: "bridge_lvl19",
          x: 156,
          y: 215,
        ...
        { type: "bridge_lvl19", x: 225, y: 88, rotation: 0, custom: "bridge2" },
        { type: "moving_fence_lvl19", x: 296, y: 73, rotation: 0 },
        { type: "earth2_lvl19", x: 297.5, y: 88, rotation: 0 },
        { type: "swamp", x: 303, y: 290, rotation: 0 },
        { type: "bubble", x: 230, y: 263, rotation: 0 },
        { type: "eyes", x: 243, y: 275, rotation: 0 },
        { type: "monster", x: 345, y: 236, rotation: 0 },
        { type: "button_red", x: 323, y: 89, rotation: 0 },
        { type: "lever", x: 273, y: 118, rotation: 0, custom: "no_static" },
        { type: "earth1_lvl19", x: 240, y: 262.5, rotation: 0 },
        { type: "log_lvl19", x: 302, y: 176, rotation: 0 },
        { type: "barell", x: 314, y: 53, rotation: 0 },
        { type: "barell", x: 349, y: 42, rotation: 0, custom: "barell" },
        { type: "earth3_lvl19", x: 140, y: 14.5, rotation: 0 },
        { type: "earth4_lvl19", x: 433, y: 15, rotation: 0 },
      ],
      joints: [
        { type: 0, point1: { x: 310, y: 176 } },
        { type: 2, point1: { x: 135, y: 109 }, point2: { x: 135, y: 8 } },
        { type: 2, point1: { x: 136, y: 109 }, point2: { x: 136, y: 8 } },
        { type: 2, point1: { x: 435, y: 227 }, point2: { x: 435, y: 2 } },
        { type: 2, point1: { x: 436, y: 227 }, point2: { x: 436, y: 2 } },
      ],
    },
    {
      objects: [
        { type: "tube1", x: 30, y: 79, rotation: 0 },
        { type: "invisible_wall_big", x: 133, y: 112, rotation: 0 },
        { type: "invisible_wall_big", x: -17, y: 112, rotation: 0 },
        { type: "invisible_wall_big", x: 359, y: 112, rotation: 0 },
        { type: "invisible_wall_big", x: 509, y: 112, rotation: 0 },
        {
          type: "invisible_wall_big",
          x: 387,
          y: 246,
        ...
        { type: "tube2", x: 464, y: 73, rotation: 0 },
        { type: "grandpa", x: 394, y: 91, rotation: 0 },
        { type: "conveyor", x: 72, y: 258, rotation: 0 },
        { type: "Lift", x: 246, y: 200, rotation: 0 },
        { type: "earth_lvl20", x: 246, y: 286.5, rotation: 0 },
        {
          type: "button_red",
          x: 176,
          y: 147,
        ...
        { type: "catcher_lvl20", x: 130, y: 86, rotation: 0 },
        { type: "earth2_lvl20", x: 131, y: 73.5, rotation: 0 },
        { type: "spring_lvl20", x: 86, y: 163, rotation: 0, custom: "spring1" },
        {
          type: "spring_lvl20",
          x: 428,
          y: 177,
        ...
        { type: "spring_lvl8", x: 359, y: 254, rotation: 0, custom: "spring3" },
        {
          type: "button_red",
          x: 61,
          y: 163,
          rotation: 0,
          custom: "button_spring1",
        },
        {
          type: "button_red",
          x: 428,
...
var stone_density = 6,
  stone_restitution = 0,
  stone_friction = 1,
  platform_density = 3e6,
  platform_restitution = -10,
  platform_friction = 0,
  obstacle_density = 1e4,
  obstacle_restitution = 0,
  obstacle_friction = 0,
  BOB_density = 10,
  BOB_restitution = 0,
  BOB_friction = 0,
  objects = [
    ...
    },
    {
      ...
      fixed: !0,
      info: "Lift",
      density: 1e3 * platform_density,
      restitution: platform_restitution,
      friction: platform_friction,
    },
    {
      name: "electricity_10",
      image: "electricity_10.png",
      width: 44,
      height: 42,
      frames: 10,
      bodyType: NONE,
    ...
    {
      name: "caterpillar",
      image: "caterpillar_move1.png",
      width: 62,
      height: 36,
      bodyHeight: 13,
      bodyWidth: 50,
      bodyPosCorrect: { x: 3, y: 7 },
      bodyType: BOX,
      frames: 9,
      fixed: !1,
      info: "caterpillar",
    ...
    {
      name: "earth_lvl1",
      image: "levels/01/earth_lvl1.png",
      width: 129,
      height: 22,
      bodyType: NONE,
      info: "earth_lvl1",
    ...
    {
      name: "ButtonSystem",
      image: "levels/02/ButtonSystem.png",
      type: BOX,
      width: 35,
      height: 32,
      frames: 6,
    ...
    {
      name: "Fire",
      image: "levels/02/Fire.png",
      width: 35,
      height: 58,
      frames: 10,
      bodyType: BOX,
      bodyPosCorrect: { x: 0, y: -2 },
      fixed: !0,
      info: "Fire",
    ...
    {
      name: "earth1_lvl3",
      image: "levels/03/earth1_lvl3.png",
      width: 37,
      height: 17,
      bodyType: NONE,
      info: "earth1_lvl3",
    ...
    {
      name: "earth2_lvl3",
      image: "levels/03/earth2_lvl3.png",
      width: 38,
      height: 17,
      bodyType: NONE,
      info: "earth2_lvl3",
    ...
    {
      name: "terminator_appear",
      image: "levels/03/terminator_appear.png",
      width: 146,
      height: 106,
      bodyWidth: 35,
      bodyHeight: 39,
      ...
      columns: 2,
      bodyType: CIRCLE,
      bodyPosCorrect: { x: 0, y: -4 },
      fixed: !1,
      density: BOB_density,
      restitution: BOB_restitution,
      friction: BOB_friction,
      info: "terminator_tiles",
    },
    {
      name: "btn_lvl3_green",
      image: "levels/03/btn_lvl3_green.png",
      width: 28,
      height: 28,
      frames: 2,
      bodyType: NONE,
    ...
    {
      name: "btn_lvl3_red",
      image: "levels/03/btn_lvl3_red.png",
      width: 28,
      height: 28,
      frames: 2,
      bodyType: NONE,
    ...
    {
      name: "doors_lvl3",
      image: "levels/03/doors_lvl3.png",
      width: 268,
      height: 108,
      frames: 8,
      bodyType: NONE,
    ...
    {
      name: "numbers_lvl3",
      image: "levels/03/numbers_lvl3.png",
      width: 147,
      height: 84,
      bodyType: NONE,
      info: "numbers_lvl3",
    ...
    {
      name: "bridge_lvl4",
      image: "levels/04/bridge_lvl4.png",
      width: 138,
      height: 17,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "earth_fixed",
      image: "levels/04/earth_fixed.png",
      width: 50,
      height: 88,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "earth_move",
      image: "levels/04/earth_move.png",
      width: 57,
      height: 155,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "antiant_anim",
      image: "levels/04/antiant_anim.png",
      width: 54,
      height: 62,
      frames: 15,
      bodyType: NONE,
    ...
    {
      name: "ant",
      image: "levels/04/ant.png",
      width: 28,
      height: 28,
      bodyWidth: 18,
      frames: 9,
      bodyType: CIRCLE,
      bodyPosCorrect: { x: -5, y: 0 },
      fixed: !1,
      density: platform_density,
      restitution: platform_restitution,
      friction: platform_friction,
    ...
    {
      name: "earth1_lvl5",
      image: "levels/05/earth1_lvl5.png",
      width: 73,
      height: 33,
      bodyType: NONE,
      info: "earth1_lvl5",
    ...
    {
      name: "earth2_lvl5",
      image: "levels/05/earth2_lvl5.png",
      width: 64,
      height: 43,
      bodyType: NONE,
      info: "earth2_lvl5",
    ...
    {
      name: "moving_fence",
      image: "levels/05/moving_fence.png",
      width: 53,
      height: 37,
      frames: 6,
      bodyType: POLY,
    ...
    {
      name: "bridge_lvl6",
      image: "levels/06/bridge_lvl6.png",
      width: 47,
      height: 18,
      bodyHeight: 15,
      bodyType: BOX,
    ...
    {
      name: "spring_lvl6",
      image: "levels/06/spring_lvl6.png",
      width: 72,
      height: 96,
      bodyWidth: 45,
      bodyHeight: 55,
      frames: 7,
      bodyPosCorrect: { x: 3, y: 15 },
      bodyType: BOX,
      fixed: !0,
      info: "spring_lvl6",
      density: platform_density,
    ...
    {
      name: "indicator_lvl6",
      image: "levels/06/indicator_lvl6.png",
      width: 12,
      height: 12,
      frames: 2,
      bodyType: NONE,
    ...
    {
      name: "bridge_lvl7",
      image: "levels/07/bridge_lvl7.png",
      width: 18,
      height: 61,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "earth_lvl7",
      image: "levels/07/earth_lvl7.png",
      width: 24,
      height: 63,
      bodyType: NONE,
      info: "earth_lvl7",
    ...
    {
      name: "ball_holder",
      image: "levels/07/ball_holder.png",
      width: 72,
      height: 55,
      bodyType: NONE,
      info: "ball_holder",
    ...
    {
      name: "skeleton",
      image: "levels/08/skeleton.png",
      width: 48,
      height: 52,
      bodyWidth: 38,
      bodyPosCorrect: { x: -9, y: -3 },
      frames: 7,
      bodyType: CIRCLE,
      fixed: !1,
      density: 10,
    ...
    {
      name: "spring_lvl8",
      image: "levels/08/spring_lvl8.png",
      width: 56,
      height: 62,
      bodyWidth: 52,
      bodyHeight: 40,
      frames: 6,
      bodyPosCorrect: { x: 0, y: 13 },
      bodyType: BOX,
      fixed: !0,
      info: "spring_lvl8",
      density: platform_density,
    ...
    {
      name: "earth_lvl8",
      image: "levels/08/earth_lvl8.png",
      width: 33,
      height: 33,
      bodyType: NONE,
      info: "earth_lvl8",
    ...
    {
      name: "bridge2_lvl8",
      image: "levels/08/bridge2_lvl8.png",
      width: 148,
      height: 15,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "trampoline",
      image: "levels/09/trampoline.png",
      width: 57,
      height: 38,
      bodyWidth: 52,
      bodyHeight: 32,
    ...
    {
      name: "earth_lvl10",
      image: "levels/10/earth_lvl10.png",
      width: 68,
      height: 30,
      bodyType: NONE,
      info: "earth_lvl10",
    ...
    {
      name: "earth_lvl11",
      image: "levels/11/earth_lvl11.png",
      width: 480,
      height: 181,
      bodyType: NONE,
      info: "earth_lvl11",
    ...
    {
      name: "ball1",
      image: "levels/12/ball1.png",
      width: 68,
      height: 142,
      bodyWidth: 31,
      bodyHeight: 31,
      bodyPosCorrect: { x: 0, y: -31 },
      frames: 7,
      bodyType: CIRCLE,
      fixed: !1,
      info: "ball",
    ...
    },
    {
      ...
      image: "levels/12/basket_invisible.png",
      width: 64,
      height: 17,
      bodyHeight: 11,
      bodyWidth: 55,
    ...
    {
      name: "earth_lvl13",
      image: "levels/13/earth_lvl13.png",
      width: 38,
      height: 78,
      bodyType: NONE,
      info: "earth_lvl13",
    ...
    {
      name: "trolley_play",
      image: "levels/13/trolley_play.png",
      width: 6,
      height: 11,
      frames: 2,
      bodyType: NONE,
    ...
    {
      name: "earth_lvl14",
      image: "levels/14/earth_lvl14.png",
      width: 76,
      height: 28,
      bodyType: NONE,
      info: "earth_lvl14",
    ...
    {
      name: "bridge_lvl14",
      image: "levels/14/bridge_lvl14.png",
      width: 67,
      height: 19,
      bodyHeight: 18,
      bodyType: BOX,
    ...
    {
      name: "igor",
      image: "levels/14/igor1.png",
      width: 50,
      height: 46,
      bodyWidth: 36,
      frames: 8,
      bodyType: CIRCLE,
      bodyPosCorrect: { x: -4, y: -4 },
      fixed: !1,
      density: BOB_density,
      restitution: BOB_restitution,
      friction: BOB_friction,
    ...
    {
      name: "dima",
      image: "levels/14/dima1.png",
      width: 52,
      height: 42,
      bodyWidth: 36,
      frames: 8,
      bodyType: CIRCLE,
      bodyPosCorrect: { x: -2, y: -3 },
      fixed: !1,
      density: BOB_density,
      restitution: BOB_restitution,
      friction: BOB_friction,
    ...
    {
      name: "jeka",
      image: "levels/14/jeka1.png",
      width: 56,
      height: 48,
      bodyWidth: 37,
      frames: 8,
      bodyType: CIRCLE,
      bodyPosCorrect: { x: 4, y: 1 },
      fixed: !1,
      density: BOB_density,
      restitution: BOB_restitution,
      friction: BOB_friction,
    ...
    {
      name: "earth_lvl15",
      image: "levels/15/earth_lvl15.png",
      width: 63,
      height: 56,
      bodyType: NONE,
      info: "earth_lvl15",
    ...
    {
      name: "bridge1_lvl16",
      image: "levels/16/bridge1_lvl16.png",
      width: 16,
      height: 118,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "bridge2_lvl16",
      image: "levels/16/bridge2_lvl16.png",
      width: 84,
      height: 17,
      bodyType: BOX,
      fixed: !0,
    ...
    {
      name: "cover_lvl16",
      image: "levels/16/cover_lvl16.png",
      width: 37,
      height: 6,
      bodyType: NONE,
      info: "cover_lvl16",
    ...
    {
      name: "earth_lvl16",
      image: "levels/16/earth_lvl16.png",
      width: 85,
      height: 24,
      bodyType: NONE,
      info: "earth_lvl16",
    ...
    {
      name: "back_blue1",
      image: "levels/16/back_blue1.png",
      width: 28,
      height: 74,
      bodyType: NONE,
      info: "back_blue1",
    ...
    {
      name: "back_blue2",
      image: "levels/16/back_blue2.png",
      width: 71,
      height: 40,
      bodyType: NONE,
      info: "back_blue2",
    ...
    {
      name: "back_orange1",
      image: "levels/16/back_orange1.png",
      width: 64,
      height: 74,
      bodyType: NONE,
      info: "back_orange1",
    ...
    {
      name: "back_orange2",
      image: "levels/16/back_orange2.png",
      width: 66,
      height: 27,
      bodyType: NONE,
      info: "back_orange2",
    ...
    {
      name: "teleport_orange",
      image: "levels/16/teleport_orange.png",
      width: 32,
      height: 108,
      frames: 18,
      rows: 9,
    ...
    {
      name: "teleport_blue",
      image: "levels/16/teleport_blue.png",
      width: 32,
      height: 108,
      frames: 18,
      rows: 9,
    ...
    },
    {
      ...
      image: "levels/16/extraterrestrial.png",
      width: 54,
      height: 42,
      bodyWidth: 36,
      frames: 8,
    ...
    {
      name: "thing_with_lamps",
      image: "levels/17/thing_with_lamps.png",
      width: 72,
      height: 19,
      bodyType: NONE,
      info: "thing_with_lamps",
    },
    {
      name: "button_green",
      image: "levels/17/button_green.png",
      width: 37,
      height: 14,
      frames: 10,
      bodyType: NONE,
    ...
    },
    {
      ...
      columns: 2,
      bodyType: BOX,
      bodyPosCorrect: { x: 0, y: 9 },
      fixed: !0,
      density: platform_density,
      restitution: platform_restitution,
      friction: platform_friction,
      info: "spring_lvl17_tiles",
    },
    {
      name: "locker",
      image: "levels/18/locker.png",
      width: 43,
      height: 65,
      bodyType: NONE,
      info: "locker",
    ...
    {
      name: "log2_lvl18",
      image: "levels/18/log2_lvl18.png",
      width: 18,
      height: 77,
      bodyHeight: 74,
      bodyType: BOX,
    ...
    {
      name: "log1_lvl18",
      image: "levels/18/log1_lvl18.png",
      width: 19,
      height: 149,
      bodyHeight: 145,
      bodyWidth: 17,
    ...
    },
    {
      ...
      height: 13,
      bodyType: NONE,
      info: "entrance_lvl18_invisible",
    },
    {
      name: "bough",
      image: "levels/18/bough.png",
      width: 45,
      height: 54,
      bodyType: NONE,
      info: "bough",
    ...
    {
      name: "woodpecker",
      image: "levels/18/woodpecker1.png",
      width: 68,
      height: 110,
      frames: 23,
      rows: 8,
      columns: 3,
      bodyType: NONE,
      info: "woodpecker_tiles",
    },
    {
      name: "bubble",
      image: "levels/19/bubble.png",
      width: 198,
      height: 14,
      frames: 54,
      bodyType: NONE,
    ...
    {
      name: "earth1_lvl19",
      image: "levels/19/earth1_lvl19.png",
      width: 480,
      height: 115,
      bodyType: NONE,
      info: "earth1_lvl19",
    ...
    {
      name: "earth2_lvl19",
      image: "levels/19/earth2_lvl19.png",
      width: 92,
      height: 37,
      bodyType: NONE,
      info: "earth2_lvl19",
    ...
    {
      name: "moving_fence_lvl19",
      image: "levels/19/moving_fence_lvl19.png",
      width: 22,
      height: 35,
      bodyType: POLY,
      points: [
    ...
    {
      name: "lift_lvl19",
      image: "levels/19/lift_lvl19.png",
      width: 125,
      height: 208,
      bodyType: POLY,
      points: [
    ...
    {
      name: "tube1_lvl19",
      image: "levels/19/tube1_lvl19.png",
      width: 93,
      height: 93,
      bodyType: POLY,
      points: [
    ...
    {
      name: "tube2_lvl19",
      image: "levels/19/tube2_lvl19.png",
      width: 57,
      height: 251,
      bodyType: NONE,
      info: "tube2_lvl19",
    ...
    {
      name: "earth3_lvl19",
      image: "levels/19/earth3_lvl19.png",
      width: 55,
      height: 29,
      bodyType: NONE,
      info: "earth3_lvl19",
    ...
    {
      name: "earth4_lvl19",
      image: "levels/19/earth4_lvl19.png",
      width: 56,
      height: 30,
      bodyType: NONE,
      info: "earth4_lvl19",
    ...
    {
      name: "conveyor",
      image: "levels/20/conveyormovie.png",
      width: 174,
      height: 22,
      bodyWidth: 160,
      bodyHeight: 18,
    ...
    {
      name: "spring_lvl20",
      image: "levels/20/spring_lvl20.png",
      width: 84,
      height: 56,
      bodyWidth: 58,
      frames: 7,
    ...
    {
      name: "catcher_lvl20",
      image: "levels/20/catcher_lvl20.png",
      width: 21,
      height: 130,
      bodyType: NONE,
      info: "catcher_lvl20",
    ...
    {
      name: "earth_lvl20",
      image: "levels/20/earth_lvl20.png",
      width: 71,
      height: 67,
      bodyType: NONE,
      info: "earth_lvl20",
    ...
    {
      name: "earth2_lvl20",
      image: "levels/20/earth2_lvl20.png",
      width: 25,
      height: 124,
      bodyType: NONE,
      info: "earth2_lvl20",
  ...
  levelsScripts = [
    {
      init: function () {
        ...
        a.fan = c;
        var c = getObjectByInfo("lever"),
          e = getObjectByInfo("trap");
        a.trap = e;
      ...
      ifBobHitFan: function () {
        var a = field.bob,
          c = levelsScripts[0].fan;
        if (c.animated && stage.hitTest(c, a) && c.x + c.width / 2 > a.x) {
          var e = 7e6 * Math.sin(c.rotation),
            c = 7e6 * -Math.cos(c.rotation);
          a.box2dBody.ApplyForce(new b2Vec2(e, c), new b2Vec2(a.x, a.y));
          "fly" != a.state &&
            ((a.selectedState = a.state),
            (a.blockClick = !0),
            a.changeState("fly"),
            a.fly.gotoAndPlay(0));
        } else
          "fly" == a.state && 15 > a.fly.currentFrame && (a.fly.stopFly = !0);
      },
      ifBobHitTrap: function () {
        var a = levelsScripts[0].trap;
        stage.hitTest(a, field.bob) &&
          field.bob.x > a.x &&
          a.hitBobAction &&
          a.hitBobAction();
      },
    ...
    },
    {
      init: function () {
        ...
        e.onenterframe = function (a) {
          20 == a.target.currentFrameX && (a.target.destroy = !0);
        };
        c.cooked = e;
        c.states.push(e);
        stage.addChild(e);
      ...
      createHint: function () {
        var a = field.bob,
          c = levelsScripts[1].button,
          e = stage.setInterval(function () {
            0 !== c.currentFrame && stage.clearInterval(e);
            if (125 < a.x) {
              var f = createObject(
                  { type: "Lvl2_Hint2", x: a.x, y: a.y - 75, rotation: 0 },
                  findObject("Lvl2_Hint2")
                ),
                g = a.y - 40,
                h = createObject(
                  { type: "arrow_hint", x: a.x, y: g, rotation: 0 },
                  findObject("arrow_hint")
                );
      ...
      createHint2: function () {
        ...
        stage.setTimeout(function () {
          if ("hide" === a.state) {
            var c = createObject(
                { type: "Lvl2_Hint3", x: a.x - 5, y: a.y - 85, rotation: 0 },
                findObject("Lvl2_Hint3")
              ),
              f = a.y - 40,
              g = createObject(
                { type: "arrow_hint", x: a.x - 5, y: f, rotation: 0 },
                findObject("arrow_hint")
              );
      ...
      checkButtonPressed: function () {
        ...
        0 === c.currentFrame &&
          ...
          (a.mech.static = !1),
          buildBackground(),
          a.button.gotoAndPlay(0),
          a.mech.gotoAndPlay(0),
      ...
      checkBobOnFire: function () {
        ...
        if (!a.BobIsCooked && stage.hitTest(a.fire, field.bob)) {
          ...
          f.x = a.fire.x;
          f.y = a.fire.y - 50;
          field.bob.box2dBody.SetCenterPosition(f, 0);
      ...
      moveLift: function () {
        var a = levelsScripts[1].lift;
        isSoundOn && mixer.play("button");
        "down" == a.direction
          ? (a.moveLift("up"), (a.direction = "up"))
          : (a.moveLift("down"), (a.direction = "down"));
      },
      pretick: function () {
        var a = levelsScripts[1];
    ...
    },
    {
      init: function () {
        ...
        a.terminator = c;
        var e = getObjectByInfo("exit"),
          c = getObjectByInfo("fence");
        c.setZIndex(1);
        c.animDelay = 2;
        c.onenterframe = function (a) {
          var c = a.target;
        ...
        a.fence = c;
        var c = getObjectByCustomInfo("bridge1"),
          f = getObjectByCustomInfo("bridge2");
        c.restrict = [c.x - 33, c.x - 1];
        ...
        c.setStatic(!0);
        c.onenterframe = function (a) {
          7 == a.target.currentFrame &&
            (a.target.stop(), a.target.setStatic(!0));
        };
        a.doors = c;
      ...
      createHint: function () {
        createObject(
          { type: "Lvl3_Hint1", x: 185, y: 85, rotation: 0 },
          findObject("Lvl3_Hint1")
        ).setStatic(!0);
        var a = createObject(
            { type: "arrow_hint5", x: 105, y: 65, rotation: 0.8 },
            findObject("arrow_hint5")
          ),
          c = fps / 2,
          e = stage.createTween(a, "y", 65, 55, c, Easing.linear.easeIn),
          f = stage.createTween(a, "y", 55, 65, c, Easing.linear.easeIn),
          g = stage.createTween(a, "x", 105, 100, c, Easing.linear.easeIn),
          a = stage.createTween(a, "x", 100, 105, c, Easing.linear.easeIn);
        e.onfinish = f.play;
        f.onfinish = e.play;
        g.onfinish = a.play;
        a.onfinish = g.play;
      ...
      redButtonClick: function (a) {
        7 === levelsScripts[2].doors.currentFrame &&
          (isSoundOn && mixer.play("button"),
        ...
        switch (a.state) {
          ...
          case 3:
            19 == a.currentFrame &&
              a.animated &&
              (a.stop(),
              c.changeState(1 == c.selectedSpeed ? "walk" : "run"),
              c.forceWakeUp(),
              (c.blockClick = !1));
            break;
          default:
      ...
      greenButtonAction: function (a) {
        ...
        if (7 === c.doors.currentFrame) {
          isSoundOn && mixer.play("lvl3_dzin");
          a.target.setStatic(!1);
          a.target.gotoAndStop(1);
          a.target.setStatic(!0);
      ...
      checkAppiarTerminator: function () {
        ...
        !a.terminatorAppear &&
          215 < c.x &&
          (isSoundOn && mixer.play("lvl3_terminator_appear"),
          (a.terminator.onenterframe = function (a) {
            16 == a.target.currentFrameX && a.target.stop();
          }),
          a.terminator.play(),
          a.fence.play(),
          (a.terminatorAppear = !0),
          stage.setTimeout(function () {
            c.box2dBody.GoToSleep();
            ...
            stage.setTimeout(function () {
              ...
              c.y = a.terminator.y - 30;
              c.scaleX = 0.1;
              c.scaleY = 0.1;
              stage.addChild(c);
              a.text = c;
              stage
                .createTween(c, "scaleX", 0.1, 1, fps / 2, Easing.linear.easeIn)
                .play();
              stage
                .createTween(c, "scaleY", 0.1, 1, fps / 2, Easing.linear.easeIn)
                .play();
            }, Math.floor(fps));
      ...
      ifPressButton: function () {
        var a = field.bob,
          c = levelsScripts[2],
          e = c.terminator;
        0 == c.btn.currentFrame &&
          stage.hitTest(a, c.btn) &&
          (isSoundOn && mixer.play("button"),
          isSoundOn && mixer.play("lvl3_doors"),
          c.btn.setStatic(!1),
          c.btn.gotoAndStop(1),
          c.btn.setStatic(!0),
          (a.look_at_terminator.state = 2),
          a.look_at_terminator.gotoAndPlay(11),
          stage.setTimeout(function () {
            a.speed = 0;
          }, Math.floor(fps / 4)),
          (e.syncX = 6),
          ...
          (e.y -= 4),
          (e.animDelay = 1),
          c.changeTerminatorImage(bitmaps.terminator_move, 52, 42, 8, 8, 1),
          c.moveTerminator.call(e),
          stage
            .createTween(
              c.text,
              "scaleX",
      ...
      ifBobHitTerminator: function () {
        var a = levelsScripts[2],
          c = field.bob,
          e = a.terminator;
        -1 != e.bitmap.src.indexOf("move") &&
          stage.hitTest(c, e) &&
          (a.changeTerminatorImage(bitmaps.terminator_attack, 80, 44, 6, 6, 1),
          (e.onenterframe = function (f) {
            f = f.target;
            5 == f.currentFrameX &&
              -1 != f.bitmap.src.indexOf("attack") &&
              ((f.scaleX = 1),
              (f.animDelay = 2),
              (e.syncX = 34),
              (e.syncY = 12),
              a.changeTerminatorImage(
                bitmaps.terminator_fight,
                112,
                91,
                42,
                11,
      ...
      ifTerminatorFall: function () {
        ...
        c.die ||
          ...
          stage.setTimeout(function () {
            ...
            c.onenterframe = function (c) {
              14 == c.target.currentFrameX &&
                ((c.target.destroy = !0),
                (e.look_at_terminator.state = 3),
                e.look_at_terminator.gotoAndPlay(16),
                isSoundOn && mixer.play("bridge1"),
                moveBridge(a.bridge1, "x", !0, 3, a.earth1),
                moveBridge(a.bridge2, "x", !1, 3),
                stage.setTimeout(a.createHint, fps));
            };
          }, 1));
      },
    ...
    },
    {
      init: function () {
        ...
        c.setStatic(!0);
        c.onenterframe = function (a) {
          8 == a.target.currentFrame &&
            (a.target.gotoAndStop(0), a.target.setStatic(!0));
        };
        a.hose = c;
      ...
      changeStateOfBridge: function (a) {
        ...
        if (0 > p && !h.antiant.animated && (a = l.GetContactList())) {
          for (a; a; a = a.next)
            if (
              a.other.sprite &&
              "ant" == a.other.sprite.info &&
              a.other.sprite.x < k.x + 60
            ) {
              var q = a.other,
                r = getDistance({ x: 244, y: 109 }, q.GetCenterPosition());
        ...
        var s = stage.setInterval(function () {
          ...
          if ((0 < p && a > e) || (0 > p && a < e))
            stage.clearInterval(s),
              l.SetOriginPosition(new b2Vec2(313, c), e),
              stage.setTimeout(function () {
                k.setStatic(!0);
                h.log.setStatic(!0);
              }, 1);
      ...
      createAnt: function () {
        var a = levelsScripts[3],
          c = createObject(
            { type: "ant", x: -15, y: 105, rotation: 0 },
            findObject("ant")
          );
        c.onenterframe = function (c) {
          var f = c.target;
          ...
          f.x > a.antiant.x &&
            ...
            c.play(),
            isSoundOn && mixer.play("lvl4_antiant"),
            (c.onfinish = function (c) {
              f.destroy = !0;
              a.hose.setStatic(!1);
      ...
      leverAction: function (a) {
        ...
        var c = levelsScripts[3];
        0 === a.currentFrame &&
          (isSoundOn && (mixer.play("lever"), mixer.play("fan_off")),
          a.setStatic(!1),
          a.play(),
          c.antiant.gotoAndStop(14),
          c.antiant.setStatic(!0));
      },
            ...
            if (1 != f.currentFrame)
              for (var g = 0; g < c.length; g++)
                410 < c[g].x &&
                  stage.hitTest(f, c[g]) &&
                  (isSoundOn &&
                    (mixer.play("button2"), mixer.play("lvl4_bridges")),
                  f.gotoAndStop(1),
                  moveBridge(
                    a["earth" + a.earthNum],
                    "y",
    ...
    },
    {
      ...
      moveArrow: function (a) {
        var c = a.y,
          e = a.x,
          f = fps / 2,
          g = stage.createTween(a, "y", c, c - 4, f, Easing.linear.easeIn),
          c = stage.createTween(a, "y", c - 4, c, f, Easing.linear.easeIn),
          h = stage.createTween(a, "x", e, e - 10, f, Easing.linear.easeIn);
      ...
      leverAction: function (a) {
        ...
        0 === a.currentFrame &&
          ...
          moveBridge(c, "x", !0, 5, levelsScripts[4].earth1));
      },
      ifPressButton: function () {
        var a = field.bob,
          c = levelsScripts[4],
          ...
          stage.setTimeout(function () {
            ...
            stage.setTimeout(function () {
              ...
              var e = stage.setInterval(function () {
                ...
                stage.hitTest(a, c.cancelSpeed)
                  ? (field.cancelSpeed = !0)
                  : (field.cancelSpeed = !1);
                stage.hitTest(c.fireball, c.cancelSpeed) &&
                  (stage
                    .createTween(
                      f,
                      "rotation",
      ...
      ifBobHitFireball: function () {
        ...
        for (a; a; a = a.next)
          a.other.sprite &&
            -1 !== a.other.sprite.bitmap.src.indexOf("Bob") &&
            bobBurns();
      },
      pretick: function () {
        var a = levelsScripts[4];
    ...
    {
      init: function () {
        var a = levelsScripts[5],
          c = getObjectByInfo("caterpillar");
        c.scaleX = -1;
        ...
        c = getObjectByInfo("btn2");
        c.onenterframe = function (a) {
          (0 != a.target.currentFrame && 2 != a.target.currentFrame) ||
            a.target.stop();
        };
        c.scaleX = 0.85;
        c.scaleY = 0.85;
      ...
      punch: function (a) {
        ...
        var c = a.caterpillar,
          e = c.box2dBody;
        0 === a.spring.currentFrame &&
          (a.spring.play(),
          isSoundOn && mixer.play("spring"),
          stage.hitTest(a.spring, c) &&
            (isSoundOn && mixer.play("punch"),
            (a = (getDistance(a.spring, c) - 35) / 7),
            stage.setTimeout(function () {
              ...
              var a = stage.setInterval(function () {
                20 > e.GetLinearVelocity().Length() &&
                  ((c.impulse = !1), stage.clearInterval(a));
              }, 1);
            }, Math.floor(a))));
      },
      leverAction: function (a) {
        var c = levelsScripts[5],
          e = a.target;
        a = c.lift;
        var f = c.caterpillar;
        0 === e.currentFrame &&
          ...
          e.play(),
          moveBridge(a, "y", !1, 8),
          a.x + a.width / 2 > f.x - f.width / 2 &&
            a.x - a.width / 2 < f.x + f.width / 2 - 5 &&
            ((e = c.caterpillar.box2dBody.GetCenterPosition()),
            c.caterpillar.box2dBody.WakeUp(),
            a.x + a.width / 2 > f.x - f.width / 2 + 15
              ? (console.log("move up"),
                f.box2dBody.ApplyForce(new b2Vec2(0, -8e7), e))
              : (f.box2dBody.ApplyForce(new b2Vec2(3e7, -7e7), e),
      ...
      moveCaterpillar: function () {
        ...
        a.GetContactList() &&
          !a.sprite.impulse &&
          (a.m_linearVelocity.x = -SPEED_WALK);
      },
      ifPressButton: function () {
        var a = levelsScripts[5],
          c = a.btn,
          e = a.caterpillar;
        stage.hitTest(c, e) && e.y < c.y && e.x - 28 < c.x
          ? 2 !== c.currentFrame &&
            (isSoundOn && (mixer.play("button"), mixer.play("bridge2")),
            c.gotoAndPlay(1),
            a.indicator_left.gotoAndStop(1),
            a.indicator_right.gotoAndStop(1),
            moveBridge(a.bridge, "x", !1, 10, a.earth))
          : 0 !== c.currentFrame &&
            (isSoundOn && (mixer.play("button2"), mixer.play("bridge1")),
            c.gotoAndPlay(4),
            a.indicator_left.gotoAndStop(0),
            a.indicator_right.gotoAndStop(0),
            moveBridge(a.bridge, "x", !0, 10, a.earth));
      },
      ifBobFalls: function () {
        260 < field.bob.y && bobFalls();
      },
      ifCaterpillarEatsBob: function () {
        var a = levelsScripts[5].caterpillar,
          c = field.bob;
        !a.eat &&
          stage.hitTest(c, a) &&
          c.x + c.width < a.x &&
          c.y < a.y &&
          ((a.bitmap = bitmaps.caterpillar_eat2),
          (a.totalFrames = 13),
          (a.width = 108),
          (a.height = 58),
          (a.syncX = 25),
          ...
          (a.y -= 13),
          world.DestroyBody(c.box2dBody),
          isSoundOn && mixer.play("caterpillar_eat"),
          stage.setTimeout(function () {
            c[c.state].visible = !1;
            c.blockClick = !0;
          }, 4 * a.animDelay),
          (a.onenterframe = function (c) {
            12 == c.target.currentFrame &&
              (a.stop(),
              (a.bitmap = bitmaps.caterpillar_move2),
              (a.totalFrames = 12),
              (a.width = 86),
              (a.height = 38),
              (a.animDelay = 2),
    ...
    },
    {
      ...
      createBall: function (a) {
        var c = createObject(
          { type: "ball_lvl7", x: a.x, y: a.y + 20, rotation: 0 },
          findObject("ball_lvl7")
        );
        box2DCreateRevoluteJoint(world, a.box2dBody, c.box2dBody, {
          x: a.x,
          y: a.y + 3,
        });
        box2DCreateDistanceJoint(
          world,
          a.box2dBody,
          c.box2dBody,
          { x: a.x, y: a.y + 3 },
      ...
      buttonMagnetAction: function () {
        ...
        c.animated
          ...
          : (isSoundOn && mixer.play("magnet_on"),
            c.play(),
            a.wire.play(),
            (e.int = stage.setInterval(function () {
              var a = e.box2dBody.GetCenterPosition().Copy(),
                a = new b2Vec2(c.x - a.x, c.y + 15 - a.y);
              a.Normalize();
              a.Multiply(2e9);
              var f = new Vector(-5, 20);
              f.rotate(-e.rotation);
              e.box2dBody.ApplyForce(
                new b2Vec2(a.x, a.y),
                new b2Vec2(e.x + f.x, e.y + f.y)
              );
            }, 1)));
      },
      ...
      ifBobCancelSpeed: function (a) {
        stage.hitTest(levelsScripts[6].ball, field.bob)
          ? (field.cancelSpeed = !0)
          : (field.cancelSpeed = !1);
      },
      leverAction: function (a) {
        ...
        0 === a.currentFrame &&
          ...
          a.cover.setStatic(!1),
          a.play(),
          moveBridge(c.bridge, "y", !0, 5, c.earth));
      },
      ifBobFalls: function () {
    ...
    },
    {
      ...
      ifPressButton: function () {
        ...
        if (0 == e.currentFrame && stage.hitTest(c, e)) {
          ...
          h.y -= 38;
          var k = {},
            l = stage.setInterval(function () {
              var a = g.m_rotation - 0.03,
                c = new Vector(0, 38);
              c.rotate(-a);
              k.x = h.x + c.x;
              k.y = h.y + c.y;
      ...
      ifAppearSkeleton: function () {
        var a = field.bob,
          c = levelsScripts[7].skeleton;
        if (
          !c.animated &&
          a.x < c.x + c.width + 10 &&
          a.x > c.x + c.width &&
          200 < a.y &&
          0 > a.box2dBody.m_linearVelocity.x
        ) {
          isSoundOn && mixer.play("lvl8_skeleton");
          for (
            var e = createRope(10, { x: 318, y: 95 }, 90),
              f = e.ropes,
              g = e.begin,
              e = 0;
            e < f.length;
          ...
          box2DCreateDistanceJoint(world, e.box2dBody, c.box2dBody, h, h);
          c.play();
          stage.setTimeout(function () {
            for (var a = 0; a < f.length; a++) f[a].visible = !0;
          }, Math.floor(fps / 1.5));
          ...
          stage.setTimeout(function () {
            ...
            c.setZIndex(15);
            c.onenterframe = function (a) {
              14 == a.target.currentFrame &&
                a.target.animated &&
                (a.target.stop(), showWinScreen());
            };
            stage.addChild(c);
          }, Math.floor(fps / 1.7));
        }
    ...
    },
    {
      init: function () {
        for (
          var a = levelsScripts[8], c = getObjectByInfo("fly_lvl9"), e = 0;
          e < c.length;
          e++
        )
        ...
        a.trampoline = c;
        var e = getObjectByCustomInfo("button_left"),
          f = getObjectByCustomInfo("button_right");
      ...
      jumpOnTrampoline: function () {
        ...
        stage.hitTest(a, c) &&
          ...
          ((a.impulse = !0),
          stage.setTimeout(function () {
            a.box2dBody.ApplyImpulse(
              new b2Vec2(0, -23e5),
              a.box2dBody.GetCenterPosition()
            );
            a.impulse = !1;
            c.gotoAndPlay(0);
            isSoundOn && mixer.play("spring");
    ...
    },
    {
      init: function () {
        for (
          var a = levelsScripts[9], c = getObjectByInfo("button_red"), e = 0;
          e < c.length;
          e++
        ) {
          var f = c[e];
        ...
        for (var g = getObjectByInfo("fan_tiles"), e = 0; e < g.length; e++)
        ...
        var h = getObjectByInfo("fan_lvl10"),
          a = getObjectByCustomInfo("button_up_no_hint");
        a.onmousedown = function (a) {
          a.target.gotoAndStop(2);
          a.target.int = stage.setInterval(function () {
      ...
      toggleFan: function (a) {
        ...
        c.animated
          ? (c.gotoAndStop(0),
            3 !== a.target.id && c.setStatic(!0),
            isSoundOn && mixer.play("fan_off"))
          : (3 !== a.target.id && c.setStatic(!1),
            isSoundOn && mixer.play("fan_on"),
            c.play());
      },
      ifBobHitFan: function () {
        for (
          var a = field.bob, c = levelsScripts[9].fans, e = 0;
          e < c.length;
          e++
        ) {
          var f = c[e];
          if (f.animated && stage.hitTest(f, a)) {
            if (3 !== e) {
              if (f.x + f.width / 2 - 10 < a.x) continue;
            } else if (280 < a.x || f.y + f.width / 2 < a.y) continue;
            var g = 3 !== e ? 0 : 3e6 * Math.sin(f.rotation),
              f = 3 !== e ? 7e6 * -Math.cos(f.rotation) : 0;
    ...
    {
      init: function () {
        var a = levelsScripts[10],
          c = createRope(16, { x: 240, y: -100 }, 9e3);
        a.ropeBegin = c.begin;
        c = c.ropes;
        a.rope = c;
        ...
        e.onenterframe = function (a) {
          8 == a.target.currentFrame &&
            ((a.target.destroy = !0), addHint.call(f), (f.blocked = !1));
        };
        a.flap = e;
      ...
      createCatcher: function (a) {
        var c = { x: a.x, y: a.y + 9 },
          e = createObject(
            { type: "catcher", x: a.x, y: a.y + 10, rotation: 0 },
            findObject("catcher")
          );
        box2DCreateRevoluteJoint(world, a.box2dBody, e.box2dBody, c);
      ...
      catching: function (a) {
        ...
        if (!a.broken && !a.catching && 25 > getDistance(c, a)) {
          ...
          c.joint = box2DCreateRevoluteJoint(
            world,
            a.box2dBody,
            c.box2dBody,
            e
          );
          c.joint2 = box2DCreateDistanceJoint(
            world,
            a.box2dBody,
            c.box2dBody,
            e,
      ...
      catchHandler: function () {
        ...
        this.onmousedown = function (f) {
          ...
          f.target.int = stage.setInterval(function () {
            ...
            "button_down" == f.target.custom
              ? e.wallStopped
                ? -110 > g.y && ((g.y += 2), a.moveRope(a.rope, !0, 2))
                : 18 > g.y && ((g.y += 2), a.moveRope(a.rope, !0, 2))
              : -150 < g.y && ((g.y -= 2), a.moveRope(a.rope, !1, 2));
      ...
      dartBtnAction: function () {
        ...
        if (!c.blocked) {
          ...
          stage.setTimeout(function () {
            ...
            a.catcher.broken = !0;
            field.bob.joint &&
              (world.DestroyJoint(field.bob.joint),
              world.DestroyJoint(field.bob.joint2));
          }, Math.floor(fps / 4));
        }
      },
      ifPressButton: function () {
    ...
    },
    {
      init: function () {
        ...
        var g = getObjectByInfo("pump_down"),
          c = getObjectByInfo("box_lvl12");
        c.box2dBody.GoToSleep();
        a.box = c;
        ...
        c.onenterframe = function (c) {
          ...
          6 == c.currentFrame &&
            (6 > c.number
              ? ((c.bitmap = bitmaps["ball" + c.number]), c.gotoAndStop(0))
              : (c.animated && (f.setStatic(!0), g.setStatic(!0), c.stop()),
                a.flyBall()));
        };
        a.ball = c;
        addStateBobShocked();
      ...
      flyBall: function () {
        var a = levelsScripts[11].ball,
          c = a.box2dBody.GetCenterPosition(),
          e = -60 < a.box2dBody.GetLinearVelocity().y ? -95e8 : 0;
      ...
      boxLetGo: function () {
        ...
        a.crane.play();
        e.int = stage.setInterval(function () {
          !(e.crushedBob || 1 > e.box2dBody.GetLinearVelocity().Length()) &&
            stage.hitTest(c, e) &&
            e.y + e.height / 2 < c.y &&
            e.x - 40 < c.x &&
            (c.changeState("BobFlatten"),
            c.BobFlatten.gotoAndPlay(0),
            c.box2dBody.Freeze(),
            stage.setTimeout(function () {
              e.box2dBody.Freeze();
            }, Math.floor(fps / 6)),
      ...
      pumpAction: function (a) {
        a = a.target;
        var c = levelsScripts[11];
        0 === c.ball.currentFrame &&
          (isSoundOn && mixer.play("ball"),
          c.ball.play(),
          c.ball.number++,
          "up" == a.position
            ? ((a.position = "down"), (a.y += 23), (a.hint.y += 23))
            : ((a.position = "up"), (a.y -= 23), (a.hint.y -= 23)));
      },
      ifBobHitTrap: function () {
    ...
    },
    {
      ...
      buttonBridgeAction: function (a) {
        ...
        isSoundOn && mixer.play("button");
        a.up
          ? (moveBridge(a, "y", !0, 5, c),
            (a.up = !1),
            isSoundOn && mixer.play("bridge1"))
          : (moveBridge(a, "y", !1, 5, c),
            (a.up = !0),
            isSoundOn && mixer.play("bridge2"));
      },
      latch1Action: function (a) {
        ...
        c.setStatic(!1);
        "up" == c.position
          ? ((c.position = "down"), (c.hint.y += 35), (a.y += 35))
          : ((c.position = "up"), (c.hint.y -= 35), (a.y -= 35));
      ...
      moveTrolley: function () {
        var a = levelsScripts[12],
          ...
          e = a.trolley,
          f = a.beetle,
          g = e.box2dBody.GetCenterPosition();
        f.x + f.width / 2 + 5 > c.x && f.x - f.width / 2 - 5 < c.x
          ? (0 === c.currentFrame &&
              (c.play(),
              isSoundOn && mixer.play("button"),
              a.trolleyPlays[0].gotoAndStop(0),
              a.trolleyPlays[1].gotoAndStop(0)),
            258 < g.x &&
              (g.x--,
              e.box2dBody.SetOriginPosition(g, 0),
              a.controlBobSpeed(!1)))
          : (2 === c.currentFrame &&
              (c.play(),
              isSoundOn && mixer.play("button2"),
              a.trolleyPlays[0].gotoAndStop(1),
              a.trolleyPlays[1].gotoAndStop(1)),
            342 > g.x &&
              (g.x++,
              e.box2dBody.SetOriginPosition(g, 0),
              a.controlBobSpeed(!0)));
      ...
      controlBobSpeed: function (a) {
        var c = field.bob,
          e = levelsScripts[12].trolley;
        stage.hitTest(c, e) &&
          c.x > e.x - e.width / 2 &&
          ((e = c.box2dBody.GetCenterPosition()),
          a ? e.x++ : e.x--,
          c.box2dBody.SetOriginPosition(e, 0));
      },
      ifBobFalls: function () {
        240 < field.bob.y && bobFalls();
      },
      pretick: function () {
        var a = levelsScripts[12];
        a.moveTrolley();
    ...
    {
      init: function () {
        var a = levelsScripts[13],
          c = getObjectByInfo("bridge_lvl14");
        c.setStatic(!0);
      ...
      createFriend: function (a, c, e) {
        ...
        c.onenterframe = function (c) {
          ...
          180 < c.y &&
            230 > c.x &&
            200 < c.x &&
            ((c.bitmap = bitmaps[a + 2]),
            (c.totalFrames = "jeka" == a ? 14 : 21),
            "igor" == a &&
              ((c.height = 44),
              (c.width = 54),
          ...
          isSoundOn && mixer.play("lever"),
            "left" == a.side
              ? ((a.side = "right"),
                ...
                moveBridge(c.bridge, "x", !1, 4, c.earth),
                isSoundOn && mixer.play("bridge2"))
              : ((a.side = "left"),
                a.rewindAndStop(5, 0),
                moveBridge(c.bridge, "x", !0, 4, c.earth),
                isSoundOn && mixer.play("bridge1"));
      },
      ifBobInPit: function () {
        var a = field.bob;
        !a.inPit &&
          ((180 < a.y && 230 > a.x && 210 < a.x) || (150 > a.y && 370 < a.x)) &&
          ((a.inPit = !0),
          stage.setTimeout(function () {
            a.changeState("BobGrowl");
            a.BobGrowl.gotoAndPlay(0);
    ...
    {
      init: function () {
        var a = levelsScripts[14],
          c = getObjectByCustomInfo("button_down_no_hint");
        ...
        c.active = 2;
        a.wheel = c;
        var e = getObjectByInfo("toy"),
          f = a.createToy2Poly(e[2].x, e[2].y);
        f.sprite = e[2];
        e[2].box2dBody = f;
      ...
      setLaserRay: function () {
        ...
        if (e.ray.visible) {
          var f = 480,
            g = new Sprite(null, 480, 2),
            f = new Vector(273, -15);
          f.rotate(-e.rotation);
          g.x = f.x + e.x;
          g.y = f.y + e.y;
          g.rotation = 0;
          for (var f = [], h = 0; h < c.length; h++) f.push(c[h]);
          f.push(a.lift);
          f.push(a.wall);
          f.push(field.bob);
          c = [];
          for (h = 0; h < f.length; h++) stage.hitTest(f[h], g) && c.push(f[h]);
          for (var f = 480, k = (g = 0); k < c.length; k++)
            (h = c[k].x - e.x), h < f && ((f = h), (g = k));
          "bob" == c[g].info &&
            ((field.bob.onLaser = !0), (e.ray.visible = !1), a.bobOnLaser());
          for (a = !0; a && 0 < f; )
      ...
      bobOnLaser: function () {
        ...
        var e = createObject(
          { type: "bullet", x: c.x, y: c.y - 6, rotation: 0 },
          findObject("bullet")
        );
        e.setZIndex(1);
        e.moveTo(
          ...
          Easing.linear.easeIn,
          function () {
            isSoundOn && mixer.play("bobWounded_15lvl");
            var c = field.bob;
            e.destroy = !0;
            c[c.state].visible = !1;
            c.blockClick = !0;
            ...
            g.onenterframe = function (a) {
              14 == a.target.currentFrameX &&
                (a.target.gotoAndPlay(9), showGameOverScreen());
            };
            stage.addChild(g);
          }
        );
      ...
      leverAction: function (a) {
        a = a.target;
        var c = levelsScripts[14],
          e = c.toys,
          c = c.wheel;
        c.block ||
          (isSoundOn && mixer.play("lever"),
          a.play(),
          e[c.active].box2dBody.IsSleeping() && e[c.active].box2dBody.WakeUp());
      },
      rotateWheel: function (a) {
        var c = levelsScripts[14],
          ...
          f = c.toys;
        e.block ||
          (isSoundOn && mixer.play("lvl15_rotate_wheel"),
          -1 !== a.target.custom.indexOf("up")
            ? ((a = Math.PI / 2), 0 !== e.active ? e.active-- : (e.active = 3))
            : ((a = -Math.PI / 2),
              3 !== e.active ? e.active++ : (e.active = 0)),
          (e.block = !0),
          e.rotateBy(
            a,
            fps,
            ...
            function () {
              for (var a = 0; a < f.length; a++) {
                ...
                if (c.box2dBody.IsSleeping()) {
                  ...
                  k.rotate(-e.rotation);
                  c.box2dBody.SetOriginPosition(
                    { x: e.x + k.x - c.correct.x, y: e.y + k.y - c.correct.y },
                    0
                  );
                }
              }
    ...
    },
    {
      init: function () {
        ...
        a.ufoLight = c;
        for (
          var c = getObjectByInfo("teleport_tiles"), e = 0;
          e < c.length;
          e++
        ) {
          var f = c[e];
        ...
        g.int = stage.setInterval(function () {
          g.teleported || (g.box2dBody.m_linearVelocity.x = SPEED_WALK);
        }, 1);
      ...
      teleportation: function (a, c, e) {
        var f = levelsScripts[15],
          g = f.extraterrestrial;
        g.x > (e ? a.x - 7 : a.x + 3) &&
          stage.hitTest(a, g) &&
          !g.teleported &&
          ((g.teleported = !0),
          e && f.back_orange1.setZIndex(2),
          isSoundOn && mixer.play("teleport"),
          g.fadeTo(0, Math.floor(fps / 4), Easing.linear.easeIn, function () {
            g.box2dBody.SetLinearVelocity(new b2Vec2(0, 0));
            g.box2dBody.m_angularVelocity = 0;
            g.box2dBody.SetOriginPosition(new b2Vec2(c.x, c.y), 0);
            g.opacity = 1;
            stage.setTimeout(function () {
              g.teleported = !1;
            }, Math.floor(fps / 2));
      ...
      ufoTakesAway: function (a) {
        ...
        if (!e.take && a.x > c.ufoLight.x - 5) {
          ...
          a == field.bob
            ? (a.changeState("bobUfo"), (a.blockClick = !0))
            : stage.clearInterval(a.int);
          world.DestroyBody(a.box2dBody);
          var f = stage.createTween(
            a,
            "y",
            a.y,
            a.y - 150,
          ...
          f.onfinish = function () {
            ...
            c.ufoLight.fadeTo(0, fps / 2, Easing.linear.easeIn, function () {
    ...
    },
    {
      init: function () {
        ...
        var e = getObjectByInfo("spring_lvl17_tiles"),
          f = getObjectByInfo("button_green");
        ...
        a.lift = f;
        for (
          var f = getObjectByCustomInfo("button_spring"),
            g = getObjectByInfo("bridge_lvl17"),
            h = getObjectByInfo("btn2"),
            k = getObjectByInfo("shutter"),
            l = getObjectByInfo("holder"),
            m = 0;
          2 > m;
          m++
        ) {
        ...
        punch.call(f, e, c, new b2Vec2(0, -2e6));
        deStaticCover("score");
      },
      shutterOnenter: function (a) {
        ...
        7 == a.currentFrame &&
          (1 == a.num ? ((a.num = 0), a.gotoAndStop(0)) : a.num++);
      },
      buttonAction: function (a) {
        var c = a.target,
          e = levelsScripts[16];
        a = -1 != c.custom.indexOf("0") ? 0 : 1;
        var f = e["buttonPress" + a],
          g = e["shutter" + a],
          h = e["bridge" + a],
          k = e["holder" + a];
        isSoundOn && mixer.play("button3");
        2 == f.currentFrame &&
          ((g.bitmap = bitmaps.shutter2),
          (g.width = 94),
          (g.x = 0 == a ? g.x + 12 : g.x - 12),
          (g.totalFrames = 7),
          (g.onenterframe = function (a) {
            var e = a.target;
            6 == e.currentFrame &&
      ...
      ifPressButton: function (a) {
        var c = levelsScripts[16],
          e = 0 == a ? field.bob : c.caterpillar,
          f = c["buttonPress" + a];
        a = c["bridge" + a];
        e.x > f.x - 30 && e.x < f.x + 30
          ? 0 === f.currentFrame &&
            (f.play(),
            moveBridge(a, "y", !1, 10),
            isSoundOn && (mixer.play("button"), mixer.play("bridge2")))
      ...
      ifCaterpillarPressButton: function () {
        ...
        160 > a.caterpillar.y &&
          0 == c.currentFrame &&
          (isSoundOn && mixer.play("button"), c.play(), moveBridge(e, "y", !1));
      },
      ifCaterpillarEatsBob: function () {
        function a() {
          isSoundOn && mixer.play("lvl17_caterpillar");
        }
        var c = levelsScripts[16].caterpillar,
          e = field.bob;
        !c.eat &&
          stage.hitTest(e, c) &&
          e.x > c.x &&
          e.y + 5 > c.y &&
          (isSoundOn && mixer.play("caterpillar_eat"),
          (c.bitmap = bitmaps.caterpillar_eat1),
          (c.totalFrames = 14),
          (c.width = 122),
          (c.height = 62),
          (c.syncX = -32),
          ...
          stage.clearInterval(c.int),
          (e.blockClick = !0),
          world.DestroyBody(e.box2dBody),
          stage.setTimeout(function () {
            e[e.state].visible = !1;
          }, 4 * c.animDelay),
          (c.onenterframe = function (e) {
            13 == e.target.currentFrame &&
              ((c.bitmap = bitmaps.caterpillar_move2),
              (c.totalFrames = 12),
              (c.width = 86),
              (c.height = 38),
              (c.syncX = -59),
              ...
              c.gotoAndPlay(0),
              a(),
              stage.setTimeout(a, c.totalFrames * c.animDelay),
              stage.setTimeout(a, 2 * c.totalFrames * c.animDelay),
    ...
    {
      init: function () {
        var a = levelsScripts[17],
          c = getObjectByInfo("bollMc");
        c.scaleX = 0.9;
        c.scaleY = 0.9;
        c.box2dBody.GoToSleep();
        a.ball = c;
        ...
        if (2 != a.num && a.currentFrameX == a.framesCount - 1)
          switch (a.num) {
            ...
            case 6:
              ...
              var e = createObject(
                { type: "log2_lvl18", x: 158, y: 65, rotation: 0 },
                findObject("log2_lvl18")
              );
              stage.setTimeout(function () {
                e.setZIndex(1);
              }, 1);
      ...
      sawAction: function (a) {
        var c = a.target,
          e = levelsScripts[17].logSaw.box2dBody,
          f = c.hint;
        if (
          !c.blocked &&
          ((a = fps / 3),
          c.left
            ? (stage
                .createTween(c, "x", 330, 355, a, Easing.linear.easeIn)
                .play(),
              stage
                .createTween(f, "x", 365, 390, a, Easing.linear.easeIn)
                .play())
            : (stage
                .createTween(c, "x", 355, 330, a, Easing.linear.easeIn)
                .play(),
              stage
                .createTween(f, "x", 390, 365, a, Easing.linear.easeIn)
                .play()),
          (c.left = !c.left),
          !c.sawnOff)
        ) {
          ...
          var g = e.GetRotation(),
            f = new Vector(-7.5, 72);
          f.rotate(-g);
          var h = e.GetCenterPosition(),
            k = h.x + f.x,
            l = h.y + f.y,
            m = {},
            n = stage.setInterval(function () {
              g -= 0.01;
          ...
          stage.setTimeout(function () {
            ...
            if (-0.9 > g) {
              ...
              a.rotate(-g);
              e.ApplyImpulse(new b2Vec2(-32e4, 0), {
                x: m.x + a.x,
                y: m.y + a.y,
              });
              c.sawnOff = !0;
      ...
      lockerAction: function (a) {
        var c = levelsScripts[17].ball.box2dBody,
          e = a.target;
        e.onclick = null;
        isSoundOn && (mixer.play("lever"), mixer.play("bridge2"));
        stage.setTimeout(function () {
        ...
        var f = e.x - 20,
          g = e.y - 24,
          h = stage.setInterval(function () {
            e.rotation -= 0.1;
            var a = new Vector(20, 24);
            a.rotate(-e.rotation);
            e.x = f + a.x;
            e.y = g + a.y;
            -1 > e.rotation && (stage.clearInterval(h), e.setStatic(!0));
          }, 1);
      },
      ifBobFalls: function () {
        260 < field.bob.y && bobFalls();
    ...
    },
    {
      init: function () {
        var a = levelsScripts[18],
          c = field.bob,
          e = new TilesSprite(bitmaps.bobSurprised, 58, 86, 14, 7, 2);
        e.setPosition(c.x, c.y);
        e.animDelay = 2;
        e.visible = !1;
        e.gotoAndStop(0);
        ...
        var f = g.box2dBody,
          e = e.box2dBody,
          h = e.GetCenterPosition(),
          k = f.GetCenterPosition(),
          l = new b2Vec2(h.x, h.y - 88),
          m = new b2Vec2(k.x, k.y - 235);
        ...
        if (0 === a.currentFrame || 5 === a.currentFrame)
          isSoundOn && mixer.play("lever"),
            "left" == a.side
              ? ((a.side = "right"),
                a.gotoAndPlay(0),
                moveBridge(c.bridge1, "x", !1, 10),
                moveBridge(c.bridge2, "x", !0, 10),
                isSoundOn && mixer.play("bridge2"))
              : ((a.side = "left"),
                a.rewindAndStop(5, 0),
                moveBridge(c.bridge1, "x", !0, 10),
                moveBridge(c.bridge2, "x", !1, 10),
                isSoundOn && mixer.play("bridge1"));
      },
      ifBobMonster: function () {
        ...
        if (!a.monster && 248 < a.y) {
          ...
          c.onenterframe = function (c) {
            14 == c.target.currentFrameX &&
              ((c.target.destroy = !0),
              (c = new Sprite(bitmaps.bobMonster2, 76, 56, 12)),
              (c.x = a.x),
              (c.y = a.y - 11),
              (c.animDelay = 2),
              stage.addChild(c),
      ...
      ifLogGoToSleep: function () {
        var a = levelsScripts[18].log.box2dBody,
          c;
      ...
      ifBobCancelSpeed: function () {
        var a = field.bob,
          c = levelsScripts[18].tube2;
        a.y - 80 < c.y && stage.hitTest(a, c)
          ? (field.cancelSpeed = !0)
          : (field.cancelSpeed = !1);
      },
      ifBarelsFall: function () {
        for (var a = levelsScripts[18].barells, c = 0; c < a.length; c++) {
          ...
          !e.fall &&
            240 < e.y &&
            ((e.fall = !0), isSoundOn && mixer.play("lvl19_water"));
        }
      },
      pretick: function () {
        var a = levelsScripts[18];
    ...
    },
    {
      init: function () {
        var a = levelsScripts[19],
          c = field.bob,
          e = new TilesSprite(bitmaps.bobWinks, 50, 42, 38, 19, 2);
        e.setPosition(c.x, c.y);
        e.visible = !1;
        e.gotoAndStop(0);
        c.bobWinks = e;
        ...
        a.createPresent();
        for (c = 1; 3 >= c; c++) {
          var e = getObjectByCustomInfo("spring" + c),
            f = getObjectByCustomInfo("button_spring" + c);
          switch (c) {
            case 1:
      ...
      buttonCatchAction: function (a) {
        ...
        if (!c.block) {
          ...
          c.block = !0;
          a = e.y;
          var g = Easing.linear.easeIn,
            h = Math.floor(0.65 * fps),
            k = stage.createTween(e, "y", a, a + 68, h, g),
            l = stage.createTween(e, "y", a + 68, a, h, g);
          k.play();
          k.onfinish = function () {
            f && f.x - f.width / 2 < e.x - 3 && f.x + f.width / 2 > e.x + 1
              ? ((f.catching = !0),
                (f.vec = new Vector(f.x - e.x, f.y - e.y + 3)),
                (l.onchange = function () {
                  var a = {};
                  a.x = e.x + f.vec.x;
                  a.y = e.y + f.vec.y;
      ...
      createPresent: function () {
        ...
        if (!a.present) {
          var c = createObject(
            { type: "present", x: -10, y: 230, rotation: 0 },
            findObject("present")
          );
          c.setZIndex(1);
          c.box2dBody.m_invI = 0;
          c.int = stage.setInterval(function () {
            ...
            stage.hitTest(a.conveyor, c) ||
              (stage.clearInterval(c.int),
              (c.int1 = stage.setInterval(function () {
                350 < c.y &&
                  (stage.clearInterval(c.int1),
                  (c.destroy = !0),
                  (a.present = null));
              }, 1)));
          }, 1);
      ...
      ifGrandpaKicksBob: function () {
        ...
        stage.hitTest(e, c) &&
          ...
          isSoundOn && mixer.play("punch"),
          stage.setTimeout(function () {
            f.ApplyImpulse(new b2Vec2(-2e6, -2e6), e);
            stage.setTimeout(function () {
              e.kicked = !1;
            }, fps / 2);
          }, 2 * c.animDelay),
          a.changeGrandpaImage(bitmaps.grandpaAngry, 80, 66, 9, -12.5, -1.5),
          (c.onenterframe = function (e) {
            8 == e.target.currentFrame &&
              (isSoundOn && mixer.play("lvl20_no"),
              a.changeGrandpaImage(bitmaps.grandpaAngry2, 66, 50, 7, 6, 1.5),
              (c.onenterframe = function (e) {
                6 == e.target.currentFrame &&
                  (a.changeGrandpaImage(bitmaps.grandpa, 54, 50, 20, 6.5),
                  (c.onenterframe = null),
                  a.addPresentThoughts());
              }));
          }));
      },
      addPresentThoughts: function () {
        var a = levelsScripts[19].grandpa,
          c = new Sprite(bitmaps.present_thoughts, 64, 50, 5);
        c.x = a.x - 43;
        c.y = a.y - 30;
        c.scaleX = 0.5;
        c.scaleY = 0.5;
      ...
      ifPresentHitGrandpa: function () {
        ...
        a.present &&
          !c.happy &&
          stage.hitTest(a.present, c) &&
          ((c.happy = !0),
          isSoundOn && mixer.play("grandfather_gift", !1, !1, 3),
          a.changeGrandpaImage(bitmaps.grandpaHappy, 54, 56, 7),
          e.changeState("bobWinks"),
          e.bobWinks.gotoAndPlay(0),
          (e.speed = SPEED_WALK / 2),
          stage.setTimeout(function () {
            e.speed = 0;
          }, fps / 2),
          (e.blockClick = !0));
...
function getObjectByCustomInfo(a) {
  for (var c = 0, e = stage.objects.length; c < e; c++)
    if (stage.objects[c].custom == a) return stage.objects[c];
  return {};
}
...
function checkIfBobOnLift(a) {
  var c = field.bob;
  if (!stage.hitTest(c, a) || c.y > a.y) return !1;
  if (a.x - a.width / 2 <= c.x && a.x + a.width / 2 >= c.x) return !0;
}
function turnBob(a) {
  var c = field.bob;
  stage.hitTest(c, a) &&
    ((c.blockClick = !0),
    "hide" != c.state && c.forceSleep(),
    (c.direction = "right" == c.direction ? "left" : "right"),
    "hide" == c.state
      ? (c.changeState("BobHideTurn"), c.BobHideTurn.gotoAndPlay(0))
      : (c.changeState("BobTurns"), c.BobTurns.gotoAndPlay(0)));
}
function processSlider(a) {
  var c = field.bob,
    e = addBobState("BobTurns", 47, 561 / 14, 14);
  e.scaleX = -1;
  e.onenterframe = function (a) {
    13 == a.target.currentFrame &&
      a.target.animated &&
      (c.forceWakeUp(), a.target.stop(), setStateAfterTurn());
  };
  ...
  e.onenterframe = function (a) {
    13 == a.target.currentFrame &&
      a.target.animated &&
      (a.target.stop(), setStateAfterTurn());
  };
  var f = this;
  ...
  f.onclick = function (e) {
    f.locked ||
      "show" == c.state ||
      c.blockClick ||
      (isSoundOn && mixer.play("baraban_turn"),
      (f.locked = !0),
      "left" == c.direction
        ? (a.gotoAndPlay(0),
          (a.onenterframe = function (c) {
            13 == c.target.currentFrame &&
              (c.target.gotoAndStop(0),
              (f.locked = !1),
              (a.onenterframe = null));
          }))
        : (a.rewindAndStop(13),
          (a.onenterframe = function (c) {
            0 == c.target.currentFrame &&
              (c.target.stop(), (f.locked = !1), (a.onenterframe = null));
          })),
      turnBob(a));
  };
}
function setStateAfterTurn() {
  var a = field.bob;
  a.changeState(
    "BobHideTurn" == a.state ? "hide" : 1 == a.selectedSpeed ? "walk" : "run"
  );
  stage.setTimeout(function () {
    a.blockClick = !1;
  }, Math.ceil(0.4 * fps));
...
function rotateHandler(a, c, e) {
  ...
  var g = this,
    ...
    k,
    l,
    m = g.GetCenterPosition();
  a.onmousedown = function () {
    if (
      gameState == STATE_GAME &&
      (a.gotoAndStop(2), -1 != a.custom.indexOf("left") && (k = !0), !h)
    ) {
      var n = g.GetRotation();
      (k && n <= c) ||
        (!k && n >= c) ||
        ((h = !0),
        g.sprite.setStatic(!1),
        e && e.setStatic(!1),
        (l = stage.setInterval(function () {
          var a = g.GetRotation(),
            a = k ? a - 0.05 : a + 0.05;
...
function moveMechanism(a, c) {
  ...
  e.onclick = function () {
    ...
    e.onenterframe = function (a) {
      a = a.target;
      5 == a.currentFrame &&
        (a.gotoAndStop(5), a.hint.removeHint(), a.setStatic(!0));
    };
    a.setStatic(!1);
    a.gotoAndPlay(0);
    c.box2dBody.WakeUp();
...
function moveBridgeMouseDown(a, c, e, f, g) {
  ...
  a.onmousedown = function (p) {
    l ||
      gameState != STATE_GAME ||
      (p.target.gotoAndStop(2),
      -1 != a.custom.indexOf("left") && (m = !0),
      (p = k.GetCenterPosition()),
      (m && p.x <= c) ||
        (!m && p.x >= c) ||
        ((l = !0),
        g &&
          (k.sprite.setStatic(!1), e && e.setStatic(!1), f && f.setStatic(!1)),
        (n = stage.setInterval(function () {
...
function moveBridge(a, c, e, f, g, h) {
  ...
  (!e && l[c] < a.restrict[0]) ||
    ...
    (a.int = stage.setInterval(function () {
      ...
      if ((!e && l[c] < a.restrict[0]) || (e && l[c] > a.restrict[1]))
        stage.setTimeout(function () {
          a.setStatic(!0);
          g && g.setStatic(!0);
          h && h();
...
function moveLift(a) {
  var c = this.box2dBody,
    e,
    f,
    g = field.bob.box2dBody,
    h = this;
  ...
  switch (a) {
    case "up":
      moveLift.int = stage.setInterval(function () {
        ...
        checkIfBobOnLift(h) &&
          ((f = g.GetCenterPosition()), (f.y -= 1), g.SetCenterPosition(f, 0));
        200 >= e.y &&
    ...
    case "down":
      moveLift.int = stage.setInterval(function () {
        ...
        c.SetCenterPosition(e, 0);
        246 <= e.y &&
          (isSoundOn && mixer.play("lvl2_lift"),
          stage.clearInterval(moveLift.int),
          stage.setTimeout(function () {
            h.setStatic(!0);
            h.cover.setStatic(!0);
  ...
  this.onclick = function (f) {
    if (0 === a.currentFrame) {
      ...
      if (20 == currentLevel) {
        ...
        if (!c) return;
        "button_spring1" == f.target.custom &&
          (levelsScripts[19].buttonCatch.block = !1);
      }
      stage.hitTest(a, c) &&
        ((f = Math.ceil((getDistance(a, c) - 24) / 7)),
        stage.setTimeout(function () {
          c.box2dBody.WakeUp();
          ...
          if (c == field.bob) {
            field.cancelSpeed = !0;
            var a = 10,
              f = stage.setInterval(function () {
                var e = c.box2dBody.GetLinearVelocity();
                20 > e.x
                  ? (stage.clearInterval(f), (field.cancelSpeed = !1))
                  : ((a += 1), (e.x -= a));
              }, 1);
          }
        }, f));
...
function ifBobShocked(a) {
  ...
  !c.isShocked &&
    ...
    ((c.isShocked = !0),
    (c.blockClick = !0),
    isSoundOn && mixer.play("bob_angel"),
    stage.setTimeout(function () {
...
function createRope(a, c, e) {
  var f = [],
    g = 11 != currentLevel ? findObject("rope_lvl7") : findObject("rope_lvl11");
  g.density = e;
  for (var h, k = 0; k < a; k++) {
    if (11 != currentLevel) {
      g.density -= e / 50;
      var l = createObject(
          { type: "rope_lvl7", x: c.x, y: c.y + 4 * k, rotation: 0 },
          g
        ),
        m = { x: l.x, y: l.y - 3 };
    } else
      (g.density -= e / 27),
        (l = createObject(
          { type: "rope_lvl11", x: c.x, y: c.y + 13 * k, rotation: 0 },
          g
        )),
        (m = { x: l.x, y: l.y - 6.5 });
    l.setZIndex(1);
    f.push(l);
    if (0 == k) {
      var n = box2DCreateCircle(
        world,
        l.x,
        l.y - (11 != currentLevel ? 2 : 11),
        1,
        1,
        !0,
        1,
...
function addStateBobGrowl() {
  ...
  addBobState("BobGrowl", 50, 42, 15).onenterframe = function (c) {
    ...
    isSoundOn &&
      !e.soundPlayed &&
      c.target.animated &&
      (mixer.play("bobGrowl"), (e.soundPlayed = !0));
    c.target.animated && (e.blockClick = !0);
    14 == c.target.currentFrame &&
      c.target.animated &&
      (1 > a
        ? (c.target.gotoAndPlay(0), a++)
        : (c.target.stop(),
          e.isAsleep && e.forceWakeUp(),
          (c = 1 == e.selectedSpeed ? "walk" : "run"),
          e.changeState(c),
          e[c].gotoAndPlay(0),
          (e.soundPlayed = !1),
          (e.blockClick = !1)));
...
function addStateBobFlatten() {
  ...
  a.onenterframe = function (a) {
    !field.bob.flatten &&
      a.target.animated &&
      (isSoundOn && mixer.play("bobFlatten"), (field.bob.flatten = !0));
    15 == a.target.currentFrame &&
      a.target.animated &&
      (a.target.stop(), showGameOverScreen());
  };
  a.animDelay = 1;
  a.setZIndex(15);
}
function bobFalls() {
  if (!field.bob.falls) {
    ...
    stage
      .createTween(c, "y", c.y, c.y + 170, 13 * c.animDelay, Easing.sine.easeIn)
      .play();
  }
}
function addStateBobShocked() {
  ...
  addBobState("shocked", 94, 102, 4).onenterframe = function (c) {
    if (
      2 == c.target.currentFrame &&
      (3 > a ? (a++, c.target.gotoAndPlay(1)) : c.target.gotoAndPlay(3),
      3 == c.target.currentFrame)
    ) {
      c.target.opacity = 0;
      c.target.stop();
...
function addStateBobFly() {
  var a = field.bob,
    c = addBobState("fly", 50, 50, 18);
  c.animDelay = 1;
  c.setZIndex(15);
  c.onenterframe = function (e) {
    12 != e.target.currentFrame || c.stopFly || e.target.gotoAndPlay(5);
    17 == e.target.currentFrame &&
      ((e =
        "hide" == a.selectedState
          ? "hide"
          : 1 == a.selectedSpeed
          ? "walk"
          : "run"),
...
var stage,
  ...
  SPEED_WALK = 1.5 * fps,
  SPEED_RUN = 3 * fps,
  MORE_GAMES_URL = "http://haleyschool.github.io/",
  WALKTHROUGH_URL = "http://haleyschool.github.io/",
  mixer,
  isMusicOn,
  isSoundOn,
  loopSound,
  ...
  editorLevel = 7,
  isWebAudioSupport = AudioMixer.isWebAudioSupport();
...
function startLoad() {
  ...
  a.height = Math.round(a.height * screenHeightCoef);
  Utils.createLayout(document.getElementById("main_container"), a);
  Utils.addEventListener("fitlayout", function () {
    stage &&
      (stage.drawScene(document.getElementById("screen")), buildBackground());
  });
  ...
  c = [];
  e = Utils.imagesRoot + "/" + Utils.globalScale + "/";
  ...
  c.push({ name: "menuBack", src: e + "menu/menuBack.jpg" });
  ...
  c.push({ name: "transporant", src: e + "menu/transporant.png" });
  ...
  c.push({ name: "lvl_numbs", src: e + "ingame/lvl_numbs.png" });
  ...
  c.push({
    ...
    src: e + "ingame/SspeedStandardBtn.png",
  });
  ...
  c.push({ name: "NextLeveButton", src: e + "NextLeveButton.png" });
  ...
  c.push({ name: "BobFall1", src: e + "BobFall1.png" });
  ...
  c.push({ name: "finalBack", src: e + "final/finalBack.jpg" });
  ...
  c.push({ name: "woodpecker_final", src: e + "final/woodpecker_final.png" });
  c.push({ name: "ant_final", src: e + "final/ant_final.png" });
  c.push({
    name: "game_complete_final",
    src: e + "final/game_complete_final.png",
  });
  ...
  c.push({ name: "cooked", src: e + "levels/02/cooked.png" });
  ...
  c.push({
    name: "look_at_terminator",
    src: e + "levels/03/look_at_terminator.png",
  });
  c.push({
    name: "terminator_attack",
    src: e + "levels/03/terminator_attack.png",
  });
  c.push({
    name: "terminator_fight",
    src: e + "levels/03/terminator_fight.png",
  });
  ...
  c.push({
    name: "textOfTerminator",
    src: e + "levels/03/textOfTerminator.png",
  });
  c.push({ name: "fire_anim_test", src: e + "levels/05/fire_anim_test.png" });
  c.push({ name: "fire_lvl5", src: e + "levels/05/fire_lvl5.png" });
  c.push({
    name: "caterpillar_blow1",
    src: e + "levels/06/caterpillar_blow1.png",
  });
  c.push({
    name: "caterpillar_blow2",
    src: e + "levels/06/caterpillar_blow2.png",
  });
  c.push({
    name: "caterpillar_blow3",
    src: e + "levels/06/caterpillar_blow3.png",
  });
  c.push({
    name: "caterpillar_eat2",
    src: e + "levels/06/caterpillar_eat2.png",
  });
  ...
  c.push({ name: "bobUfo", src: e + "levels/16/bobUfo.png" });
  c.push({ name: "shutter2", src: e + "levels/17/shutter2.png" });
  c.push({
    name: "caterpillar_eat1",
    src: e + "levels/17/caterpillar_eat1.png",
  });
  for (h = 2; 7 >= h; h++)
    c.push({
      name: "woodpecker" + h,
      src: e + "levels/18/woodpecker" + h + ".png",
    });
...
function loadImagesEnd(a) {
  ...
  isWebAudioSupport &&
    (a.push("Music/ball"),
    a.push("Music/baraban_turn"),
    a.push("Music/bob_angel"),
    a.push("Music/bobFalls"),
    a.push("Music/bobFlatten"),
    a.push("Music/bobGrowl"),
    a.push("Music/bobMonster"),
    a.push("Music/bobOnFire"),
    a.push("Music/bobWounded_15lvl"),
    a.push("Music/bridge1"),
    a.push("Music/bridge2"),
    a.push("Music/button"),
    a.push("Music/button2"),
    a.push("Music/button3"),
    a.push("Music/caterpillar_eat"),
    a.push("Music/dima"),
    a.push("Music/electricity"),
    a.push("Music/fan_off"),
    a.push("Music/fan_on"),
    a.push("Music/game_victory"),
    a.push("Music/hunter_shot"),
    a.push("Music/igor"),
    a.push("Music/lever"),
    a.push("Music/lvl11_dart"),
    a.push("Music/lvl12_crane"),
    a.push("Music/lvl15_rotate_wheel"),
    a.push("Music/lvl16_ufo_bye_bye"),
    a.push("Music/lvl19_water"),
    a.push("Music/lvl2_boiler"),
    a.push("Music/lvl2_lift"),
    a.push("Music/lvl20_no"),
    a.push("Music/lvl3_dzin"),
    a.push("Music/lvl4_antiant"),
    a.push("Music/lvl4_bridges"),
    a.push("Music/lvl5_fireball"),
    a.push("Music/lvl17_caterpillar"),
    a.push("Music/lvl17_shutter"),
    a.push("Music/lvl8_skeleton"),
    a.push("Music/lvl20_catcher"),
    a.push("Music/magnet_on"),
    a.push("Music/oops"),
    a.push("Music/punch"),
    a.push("Music/saw"),
    a.push("Music/speed1"),
    a.push("Music/speed2"),
    a.push("Music/spring"),
    a.push("Music/teleport"),
    a.push("Music/terminator_fight"),
    a.push("Music/trap"),
    a.push("Music/ufo_takes"),
    a.push("Music/woodpecker"),
    a.push("Music/lvl3_doors"),
    a.push("Music/lvl3_terminator_appear"),
    a.push("Music/fire"),
    a.push("Music/bob_hideshell"),
    a.push("Music/bob_outshell"),
    a.push("Music/caterpillar_happy"),
    a.push("Music/caterpillar_sad"),
    a.push("Music/grandfather_gift"),
    a.push("Music/final"),
    a.push("Music/bob_skeleton"),
    a.push("Music/ComicsMusic1"));
...
function loadSoundsEnd() {
  ...
  document.getElementById("screen_background_container").style.display =
    "block";
  getLevelsScores();
  isSoundOn =
    2 == parseInt(Utils.getCookie("snail_bob_sound"))
      ? (isMusicOn = !1)
      : (isMusicOn = !0);
...
function showSplashLogo() {
  ...
  a.onclick = function (a) {
    ...
    var g = stage.setInterval(function () {
      ...
      f.x += 2;
      300 <= f.width &&
        (stage.clearInterval(g), (gameState = STATE_SPLASH), createScene());
    }, 1);
  };
  stage.addChild(a);
...
function showFinalScreen() {
  function a() {
    ...
    a.y = 30;
    stage.addChild(a);
    var c = stage.createTween(a, "x", a.x, 240, fps, Easing.quartic.easeOut),
      a = new Sprite(bitmaps.thanks_final, 220, 34);
    a.x = 590;
    a.y = 70;
    stage.addChild(a);
    var a = stage.createTween(a, "x", a.x, 240, fps, Easing.quartic.easeOut),
      e = new SpritesGroup(stage);
    e.x = -150;
    e.y = 110;
    ...
    f.gy = 0;
    e.addChild(f, !0);
    var f = getTotalLevelsScores(),
      g = new SimpleText(bitmaps.numb_final, 22, 24);
    g.align = g.ALIGN_LEFT;
    g.x = 55;
    g.y = 1;
    g.write(f);
    g.addToGroup(e);
    var e = stage.createTween(e, "x", e.x, 240, fps, Easing.quartic.easeOut),
      h = new Sprite(bitmaps.menu_btn, 84, 50);
    h.x = 500;
    h.y = 300;
  ...
  h.onenterframe = function (c) {
    c = c.target;
    30 == c.currentFrameX &&
      (c.gotoAndPlay(19), c.tweensCreated || ((c.tweensCreated = !0), a()));
  };
  h.stop();
  f.addChild(h, !0);
  ...
  k.gscaleX = -1;
  k.grotation = 0.3;
  var l = c("ant_final", 23, 32, 1, -33.5, 46.5);
  ...
  k.onfinish = function () {
    for (var a = 0; a < stage.objects.length; a++)
      -1 === stage.objects[a].bitmap.src.indexOf("final") &&
        (stage.objects[a].destroy = !0);
    g.static = !0;
    l.static = !0;
    h.play();
    buildBackground();
...
function createComix(a) {
  ...
  c.setZIndex(1);
  stage.addChild(c);
  var e = Math.floor(2.7 * fps),
    f = stage.createTween(c, "x", 720, 240, e, Easing.exponential.easeOut),
    g = stage.createTween(c, "x", 240, -240, e, Easing.exponential.easeOut);
  f.play();
  f.onfinish = function () {
    a++;
...
function debugDraw() {
  if (gameState != STATE_GAME || !showDebugDraw) return !1;
...
function step() {
  ...
  "fly" != field.bob.state &&
    !field.cancelSpeed &&
    field.bob.box2dBody.GetContactList() &&
    (field.bob.box2dBody.m_linearVelocity.x = field.bob.speed);
  checkIfWin();
}
function mainLoop() {
  gameState == STATE_GAME &&
    (field.rebuildBack && ((field.rebuildBack = !1), buildBackground()),
...
function showLevelSelect() {
  ...
  function a(a, c) {
    var e = new Sprite(
      0 > levelsScores[g - 1] ? bitmaps.Lvl_locked : bitmaps.LvlN,
      37,
      36
    );
    e.x = a;
    ...
    e.onmousedown = function (a) {
      if (0 == a.target.index - 1 || 0 <= levelsScores[a.target.index - 2])
        return (
          (currentLevel = a.target.index),
          1 !== currentLevel
            ? stage.setTimeout(prepareLevel, Math.floor(fps / 4))
            : ((gameState = STATE_COMICS), createScene(), (firstLevel = !0)),
          !1
        );
    };
    stage.addChild(e);
    ...
    if (0 == g || 0 <= levelsScores[g - 1])
      (f = new SimpleText(bitmaps.numb, 15, 16)),
        (f.align = f.ALIGN_CENTER),
        (f.x = e.x),
        (f.y = e.y + 2),
        (f.static = !0),
        f.write(g + 1);
    g == h &&
      ((f = new Sprite(bitmaps.present, 31, 39)),
      (f.x = e.x - 20),
      (f.y = e.y + 10),
      (f.scaleX = 0.5),
      (f.scaleY = 0.5),
  ...
  e.static = !0;
  stage.addChild(e);
  var e = getTotalLevelsScores(),
    f = new SimpleText(bitmaps.score_num, 12, 16);
  f.align = f.ALIGN_CENTER;
  f.x = 296;
  f.y = 17;
  f.static = !0;
...
function showMenu() {
  ...
  stage.addChild(a);
  attachMouseEvents.call(a);
  a = new Sprite(bitmaps.moreGames, 144, 44, 4);
  a.x = 230;
  a.y = 218;
  a.stop();
  a.onclick = function () {
...
function showCredits() {
  ...
  if (gameState == STATE_MENU) {
    ...
    g.onfinish = a;
    var h = new Sprite(bitmaps.credits_back, 200, 171);
    h.gx = 0;
    h.gy = 0;
    f.addChild(h, !0);
...
function checkIfWin() {
  stage.hitTest(field.bob, field.destination) &&
    17 > getDistance(field.bob, field.destination) &&
    showWinScreen();
}
  ...
  if (gameState == STATE_GAME)
    if (
      ...
      levelsScores[currentLevel - 1] < gameScore &&
        ((levelsScores[currentLevel - 1] = gameScore), saveLevelsScores()),
      isSoundOn && mixer.play("game_victory"),
      ...
      a.write(gameScore);
      a.addToGroup(c);
      var f = stage.setInterval(function () {
          c.scaleX += 0.06;
          c.scaleY += 0.06;
          1 <= c.scaleX &&
            ((c.scaleX = 1),
            (c.scaleY = 1),
            (g.opacity = h.opacity = 1),
            stage.clearInterval(f));
        }, 1),
        g = new Sprite(bitmaps.NextLeveButton, 108, 37);
      g.setPosition(290, 220);
      g.opacity = 0;
      g.onclick = function () {
        currentLevel != levels.length && levels[currentLevel].objects.length
...
function showGameOverScreen() {
  stage.setTimeout(function () {
    if (gameState == STATE_GAME) {
      ...
      a.setPosition(getStageCenter(), getStageHeightCenter());
      stage.addChild(a);
      a = new Sprite(bitmaps.TryAgainButton, 101, 50);
...
var SnailBob = function () {
  var a = getBobLocation(),
    c = (this.obj = createObject(
      { type: "Bob", x: a.x, y: a.y, rotation: 0 },
      findObject("Bob")
    ));
  c.states = [];
  c.onbox2dsync = disableSpriteRotation;
  ...
  c.states.push(a);
  stage.addChild(a);
  a = new Sprite(bitmaps.BobRun, 57, 50, 19);
  a.setPosition(c.x, c.y);
  a.animDelay = 1;
  a.setZIndex(15);
  a.visible = !1;
    ...
    c.blockClick ||
      ...
      c.isAsleep
        ? (stage.setTimeout(function () {
          ...
          a.target.changeState("show"),
          c.show.rewindAndStop(10),
          stage.setTimeout(function () {
            "show" == c.state && c[c.state].visible
              ? (a.target.changeState(1 == c.selectedSpeed ? "walk" : "run"),
                c.forceWakeUp(),
                (c.blockClick = !1))
              : console.log(
                  "\u0442\u043e, \u0447\u0442\u043e \u0434\u043b\u044f 5-\u0433\u043e \u0443\u0440\u043e\u0432\u043d\u044f"
                );
          }, 12 * f.animDelay))
        : (stage.setTimeout(function () {
            isSoundOn && mixer.play("bob_hideshell");
          }, 2 * f.animDelay),
          a.target.changeState("hide"),
          c.hide.gotoAndPlay(0),
          c.forceSleep(),
          stage.setTimeout(function () {
            c.blockClick = !1;
...
function getBobLocation() {
  for (var a = 0, c = stage.objects.length; a < c; a++) {
    ...
    if (e.info && -1 != e.info.indexOf("entrance")) {
      ...
      if (!e.custom)
        var g = stage.setInterval(function () {
          stage.hitTest(field.bob, e) ||
            (f && f.setStatic(!0), e.setStatic(!0), stage.clearInterval(g));
        }, fps);
      return { x: e.x - 7, y: e.y + 12 };
    }
  }
}
    ...
    if (levels[c]) {
      ...
      if (g)
        for (l = 0; l < g.length; l++)
          (f = g[l]),
            (h = getBodyByPoint(f.point1)),
            (k = getBodyByPoint(f.point2 ? f.point2 : f.point1, h)),
            0 == f.type &&
              box2DCreateRevoluteJoint(world, h, k, f.point1, f.custom),
            1 == f.type &&
              box2DCreateDistanceJoint(world, h, k, f.point1, f.point2),
            2 == f.type &&
              box2DCreatePrismaticJoint(world, h, k, f.point2, f.custom);
      hideInvisibleImg();
      stopAnimations();
      a.setBobDestination();
      a.bob = new SnailBob();
      ...
      g =
        1 != GET.debug
          ? levelsScripts[currentLevel - 1]
          : levelsScripts[editorLevel - 1];
      g.init();
      ...
      this.locked ||
        ...
        this === f
          ? ((g.locked = !1),
            k.gotoAndStop(0),
            (c.selectedSpeed = 1),
            "run" == c.state && c.changeState("walk"),
            isSoundOn && mixer.play("speed1"),
            (h.x = 56))
          : ((f.locked = !1),
            k.gotoAndStop(1),
            (c.selectedSpeed = 2),
            "walk" == c.state && c.changeState("run"),
            isSoundOn && mixer.play("speed2"),
            (h.x = 85)),
        c.isAsleep ||
          (a.bob.speed = "right" == a.bob.direction ? this.value : -this.value),
        buildBackground());
    }
    var e =
      1 != GET.debug
        ? new Sprite(bitmaps["Lvl" + currentLevel + "_back"], 480, 320)
        : new Sprite(bitmaps["Lvl" + editorLevel + "_back"], 480, 320);
    e.setPosition(getStageCenter(), getStageHeightCenter());
    e.static = !0;
    stage.addChild(e);
    var f = new Sprite(bitmaps.SspeedStandardBtn, 28, 28);
    f.setPosition(56.5, 21.5);
    f.value = SPEED_WALK;
    f.onclick = c;
    f.locked = !0;
    f.static = !0;
...
function getBodyByPoint(a, c) {
  ...
  if (
    a &&
    ((stack = stage.getObjectsStackByCoord(a.x, a.y, !1)), 0 < stack.length)
  )
...
function createObject(a, c) {
  var e, f, g, h, k, l, m, n;
  mc =
    c.info && -1 == c.info.indexOf("tiles")
      ? new Sprite(bitmaps[c.name], c.width, c.height, c.frames)
      : new TilesSprite(
          bitmaps[c.name],
          c.width,
          c.height,
  ...
  if (c.bodyType != NONE) {
    ...
    l = a.y;
    c.bodyPosCorrect &&
      ((k += c.bodyPosCorrect.x),
      (l += c.bodyPosCorrect.y),
      (mc.syncX = c.bodyPosCorrect.x),
      (mc.syncY = c.bodyPosCorrect.y),
    ...
    c.bodyType == CIRCLE &&
      (e = box2DCreateCircle(world, k, l, m / 2, a.rotation, fixed, f, g, h));
    c.bodyType == POLY &&
      (e = box2DCreatePoly(world, k, l, c.points, a.rotation, fixed, f, g, h));
    if (c.joints)
      for (f = 0; f < c.joints.length; f++)
        "pivot" == c.joints[f].type &&
          ((g = new Vector(c.joints[f].x, c.joints[f].y)),
          0 != a.rotation && g.rotate(-a.rotation),
          (g.x += a.x),
          (g.y += a.y),
          (g = box2DCreateCircle(world, g.x, g.y, 1, 0, !0, 0.01, 0, 0)),
          box2DCreateRevoluteJoint(world, g, e, g.GetCenterPosition()));
    e.sprite = mc;
    mc.box2dBody = e;
  }
  mc.info = c.info;
  ...
  if ("lever" == c.info) {
    ...
    (a.custom && -1 != a.custom.indexOf("no_static")) ||
      (p && (p.static = !0), (mc.static = !0));
    p = new Vector(0, -5);
    p.rotate(-mc.rotation);
    addHint.call(mc, p.x, p.y);
  }
  "button_red" == c.info &&
    (attachMouseEvents.call(mc), "dont_hint" != a.custom && addHint.call(mc));
  if ("button_blue_down" == c.info || "button_blue_left" == c.info)
    attachMouseEvents.call(mc),
      (a.custom && -1 != a.custom.indexOf("no_hint")) ||
        ((e = new Vector(-1, 0)),
        e.rotate(-a.rotation),
        addHint.call(mc, e.x, e.y));
  mc.obType = c.type;
  return mc;
}
...
function toggleSound(a) {
  mixer &&
    (isMusicOn
      ? ((isMusicOn = isSoundOn = !1),
        mixer.stop(1),
        mixer.stop(0),
        a.target.gotoAndStop(1),
        Utils.setCookie("snail_bob_sound", 2))
      : (isWebAudioSupport && (isSoundOn = !0),
        (isMusicOn = !0),
        mixer.play("background_music", !0, !0, 0),
        loopSound && mixer.play(loopSound, !0, !0, 1),
        a.target.gotoAndStop(0),
...
function createStage() {
  ...
  stage = new Stage(
    "screen",
    Math.round(480 * screenWidthCoef),
    Math.round(320 * screenHeightCoef)
  );
  stage.delay = 1e3 / fps;
  stage.showFPS = !1;
